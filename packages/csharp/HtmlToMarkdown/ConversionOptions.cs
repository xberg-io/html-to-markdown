...
// alef:hash:0c070d1f694b76c430f2ae933f6e18dc1f28a1e6c3d5b0082059f81ec365f989
...
public sealed record ConversionOptions
{
    ...
    public ListIndentType ListIndentType { get; init; } = ListIndentType.Spaces;
    ...
    public HighlightStyle HighlightStyle { get; init; } = HighlightStyle.DoubleEqual;
    ...
    public WhitespaceMode WhitespaceMode { get; init; } = WhitespaceMode.Normalized;
    ...
    public CodeBlockStyle CodeBlockStyle { get; init; } = CodeBlockStyle.Backticks;
    ...
    public PreprocessingOptions Preprocessing { get; init; } = new PreprocessingOptions();
    ...
    public UrlEscapeStyle UrlEscapeStyle { get; init; } = UrlEscapeStyle.Angle;

    /// <summary>
    /// Link rendering style (inline or reference).
    /// </summary>
    [JsonPropertyName("link_style")]
    public LinkStyle LinkStyle { get; init; } = LinkStyle.Inline;
