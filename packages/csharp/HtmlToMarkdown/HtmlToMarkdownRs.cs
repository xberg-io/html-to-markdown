...
// alef:hash:dbadc2cdba9ce75d6acfadd3247551b05f3f0967c19abac06bfc11daf70313eb
#nullable enable
...
public static class HtmlToMarkdownRs
{
    ...
    public static LinkType LinkMetadataClassifyLink(string href)
    {
        ...
        var returnValue = new LinkType(nativeResult);
        return returnValue;
    }
    ...
    public static ConversionOptions ConversionOptionsDefault()
    {
        ...
        var returnValue = new ConversionOptions(nativeResult);
        return returnValue;
    }
    ...
    public static PreprocessingOptions PreprocessingOptionsDefault()
    {
        ...
        var returnValue = new PreprocessingOptions(nativeResult);
        return returnValue;
    }
