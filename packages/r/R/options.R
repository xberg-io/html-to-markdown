...
# alef:hash:280c3e5a65b898bd360ae903a20dfccea10b7e10728d18488fe7585177e54d8a
...
#' @param base_url Base URL to resolve relative `href`/`src` destinations against
...
conversion_options <- function(
  ...
  if (!is.null(base_url)) opts$base_url <- base_url
