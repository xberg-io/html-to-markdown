...
# alef:hash:36542949748191983b85396edc62cdc81625d2f04dac62ca9246b2ad2c838f05
...
#' @field base_url Base URL to resolve relative `href`/`src` destinations against.
...
#' @field base_url Optional override for [`ConversionOptions::base_url`].
