...
impl NodeContent {
    ...
    pub fn _factory_table(grid: TableGrid) -> NodeContent {
        html_to_markdown_rs::NodeContent::Table { grid: grid.into() }.into()
    }
    ...
    pub fn _factory_metadata_block(entries: Vec<MetadataEntry>) -> NodeContent {
        html_to_markdown_rs::NodeContent::MetadataBlock {
