...
// alef:hash:b6f616febafc79f4608e5c53b0115bd81a963bd8492921b4b5d881a95d595475
...
{
    public function __construct(
        /** @var ?string Optional override for [`ConversionOptions::heading_style`]. */
        public readonly ?string $headingStyle = null,
        /** @var ?string Optional override for [`ConversionOptions::list_indent_type`]. */
        public readonly ?string $listIndentType = null,
        ...
        /** @var ?string Optional override for [`ConversionOptions::highlight_style`]. */
        public readonly ?string $highlightStyle = null,
        /** @var ?bool Optional override for [`ConversionOptions::extract_metadata`]. */
        public readonly ?bool $extractMetadata = null,
        /** @var ?string Optional override for [`ConversionOptions::whitespace_mode`]. */
        public readonly ?string $whitespaceMode = null,
        ...
        /** @var ?string Optional override for [`ConversionOptions::newline_style`]. */
        public readonly ?string $newlineStyle = null,
        /** @var ?string Optional override for [`ConversionOptions::code_block_style`]. */
        public readonly ?string $codeBlockStyle = null,
        ...
        /** @var ?string Optional override for [`ConversionOptions::link_style`]. */
        public readonly ?string $linkStyle = null,
        /** @var ?string Optional override for [`ConversionOptions::output_format`]. */
...
final class PreprocessingOptionsUpdate
{
    public function __construct(
        ...
        /** @var ?string Optional preprocessing preset level override (Minimal, Standard, Aggressive) */
