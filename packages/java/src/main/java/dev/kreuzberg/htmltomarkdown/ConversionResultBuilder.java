...
// alef:hash:9ce43d77d767670b096136050802cf655859a481f6bca2862085da0d27698e42
...
public class ConversionResultBuilder {
    ...
    public ConversionResult build() {
        return new ConversionResult(content, document.orElse(null), metadata, tables, images, warnings);
    }
}
