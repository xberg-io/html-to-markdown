...
// alef:hash:749cf3be21cc958e41daac858c2ac8f79129d2a76e33aae81e54af0ce95630eb
...
final class NativeLib {
    ...
    static final MethodHandle HTM_CONVERSION_RESULT_TO_JSON = LIB.find("htm_conversion_result_to_json").map(s -> LINKER.downcallHandle(s, FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS))).orElse(null);
