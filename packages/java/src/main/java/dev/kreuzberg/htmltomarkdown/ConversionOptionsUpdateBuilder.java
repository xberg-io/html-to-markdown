...
// alef:hash:ed100a03c90ed347e86a1ce3882434a643b6c55e272eb4d44ea004b3c98e111e
...
public class ConversionOptionsUpdateBuilder {
    ...
    public ConversionOptionsUpdate build() {
        return new ConversionOptionsUpdate(headingStyle.orElse(null), listIndentType.orElse(null),
                listIndentWidth.orElse(null), bullets, strongEmSymbol.orElse(null), escapeAsterisks.orElse(null),
                escapeUnderscores.orElse(null), escapeMisc.orElse(null), escapeAscii.orElse(null), codeLanguage,
                autolinks.orElse(null), defaultTitle.orElse(null), brInTables.orElse(null), highlightStyle.orElse(null),
                extractMetadata.orElse(null), whitespaceMode.orElse(null), stripNewlines.orElse(null),
                wrap.orElse(null), wrapWidth.orElse(null), convertAsInline.orElse(null), subSymbol, supSymbol,
                newlineStyle.orElse(null), codeBlockStyle.orElse(null), keepInlineImagesIn.orElse(null),
                preprocessing.orElse(null), encoding, debug.orElse(null), stripTags.orElse(null),
                preserveTags.orElse(null), skipImages.orElse(null), linkStyle.orElse(null), outputFormat.orElse(null),
