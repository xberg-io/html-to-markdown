...
// alef:hash:38eec4295138d49234aafd518182f39580b6df74d5c5e7ac27bd2dedb714d74e
...
impl From<DocumentMetadata> for html_to_markdown_rs::DocumentMetadata {
    fn from(val: DocumentMetadata) -> Self {
        Self {
            ...
            keywords: val.keywords.into(),
            author: val.author.into(),
            canonical_url: val.canonical_url.into(),
            base_href: val.base_href.into(),
            language: val.language.into(),
            text_direction: val.text_direction.into(),
            open_graph: val.open_graph.into(),
            twitter_card: val.twitter_card.into(),
            meta_tags: val.meta_tags.into(),
        }
    }
}
...
impl From<HeaderMetadata> for html_to_markdown_rs::HeaderMetadata {
    fn from(val: HeaderMetadata) -> Self {
        Self {
            ...
            text: val.text.into(),
            id: val.id.into(),
            depth: val.depth.into(),
            html_offset: val.html_offset.into(),
        }
    }
}
...
impl From<ImageMetadata> for html_to_markdown_rs::ImageMetadata {
    fn from(val: ImageMetadata) -> Self {
        Self {
            ...
            alt: val.alt.into(),
            title: val.title.into(),
            dimensions: val.dimensions.into(),
...
impl From<StructuredData> for html_to_markdown_rs::StructuredData {
    fn from(val: StructuredData) -> Self {
        Self {
            ...
            raw_json: val.raw_json.into(),
            schema_type: val.schema_type.into(),
        }
    }
}
...
impl From<HtmlMetadata> for html_to_markdown_rs::HtmlMetadata {
    fn from(val: HtmlMetadata) -> Self {
        Self {
            ...
            headers: val.headers.into(),
            links: val.links.into(),
            images: val.images.into(),
            structured_data: val.structured_data.into(),
        }
    }
}
...
impl From<ConversionOptions> for html_to_markdown_rs::ConversionOptions {
    fn from(val: ConversionOptions) -> Self {
        Self {
            ...
            list_indent_width: val.list_indent_width.into(),
            bullets: val.bullets.into(),
            strong_em_symbol: val.strong_em_symbol.into(),
            escape_asterisks: val.escape_asterisks.into(),
            escape_underscores: val.escape_underscores.into(),
            escape_misc: val.escape_misc.into(),
            escape_ascii: val.escape_ascii.into(),
            code_language: val.code_language.into(),
            autolinks: val.autolinks.into(),
            default_title: val.default_title.into(),
            br_in_tables: val.br_in_tables.into(),
            highlight_style: val.highlight_style.into(),
            extract_metadata: val.extract_metadata.into(),
            whitespace_mode: val.whitespace_mode.into(),
            strip_newlines: val.strip_newlines.into(),
            wrap: val.wrap.into(),
            wrap_width: val.wrap_width.into(),
            convert_as_inline: val.convert_as_inline.into(),
            sub_symbol: val.sub_symbol.into(),
            sup_symbol: val.sup_symbol.into(),
            newline_style: val.newline_style.into(),
            code_block_style: val.code_block_style.into(),
            keep_inline_images_in: val.keep_inline_images_in.into(),
            preprocessing: val.preprocessing.into(),
            encoding: val.encoding.into(),
            debug: val.debug.into(),
            strip_tags: val.strip_tags.into(),
            preserve_tags: val.preserve_tags.into(),
            skip_images: val.skip_images.into(),
            link_style: val.link_style.into(),
            output_format: val.output_format.into(),
            include_document_structure: val.include_document_structure.into(),
            extract_images: val.extract_images.into(),
            max_image_size: val.max_image_size.into(),
            capture_svg: val.capture_svg.into(),
            infer_dimensions: val.infer_dimensions.into(),
            max_depth: val.max_depth.into(),
            exclude_selectors: val.exclude_selectors.into(),
            ..Default::default()
        }
    }
}
...
impl From<PreprocessingOptions> for html_to_markdown_rs::PreprocessingOptions {
    fn from(val: PreprocessingOptions) -> Self {
        Self {
            ...
            remove_navigation: val.remove_navigation.into(),
            remove_forms: val.remove_forms.into(),
        }
    }
}
...
impl From<DocumentStructure> for html_to_markdown_rs::DocumentStructure {
    fn from(val: DocumentStructure) -> Self {
        Self {
            nodes: val.nodes.into(),
            source_format: val.source_format.into(),
        }
    }
}
...
impl From<DocumentNode> for html_to_markdown_rs::DocumentNode {
    fn from(val: DocumentNode) -> Self {
        Self {
            ...
            children: val.children.into(),
            annotations: val.annotations.into(),
            attributes: val.attributes.into(),
        }
    }
}
...
impl From<GridCell> for html_to_markdown_rs::GridCell {
    fn from(val: GridCell) -> Self {
        Self {
            ...
            row: val.row.into(),
            col: val.col.into(),
            row_span: val.row_span.into(),
            col_span: val.col_span.into(),
            is_header: val.is_header.into(),
        }
    }
}
