...
fn ruby_init(ruby: &Ruby) -> Result<(), Error> {
    ...
    let class = module.define_class("NodeContent", ruby.class_object())?;

    class.define_singleton_method("heading", function!(NodeContent::_factory_heading, 2))?;

    class.define_singleton_method("paragraph", function!(NodeContent::_factory_paragraph, 1))?;

    class.define_singleton_method("list", function!(NodeContent::_factory_list, 1))?;

    class.define_singleton_method("list_item", function!(NodeContent::_factory_list_item, 1))?;

    class.define_singleton_method("table", function!(NodeContent::_factory_table, 1))?;

    class.define_singleton_method("image", function!(NodeContent::_factory_image, 3))?;

    class.define_singleton_method("code", function!(NodeContent::_factory_code, 2))?;

    class.define_singleton_method("definition_item", function!(NodeContent::_factory_definition_item, 2))?;

    class.define_singleton_method("raw_block", function!(NodeContent::_factory_raw_block, 2))?;

    class.define_singleton_method("metadata_block", function!(NodeContent::_factory_metadata_block, 1))?;

    class.define_singleton_method("group", function!(NodeContent::_factory_group, 3))?;

    let class = module.define_class("AnnotationKind", ruby.class_object())?;

    class.define_singleton_method("link", function!(AnnotationKind::_factory_link, 2))?;
