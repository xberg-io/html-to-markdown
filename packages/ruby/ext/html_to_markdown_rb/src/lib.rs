...
// alef:hash:3d172e1d61e4354247c7ad9184b956ee424899a8de3994fe25ed8af5c0270da1
...
pub fn convert(args: &[magnus::Value]) -> Result<ConversionResult, Error> {
    ...
    let mut options_core = html_to_markdown_rs::ConversionOptions::default();
    options_core.visitor = visitor_handle;
