...
enum class WarningKind {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("encoding_fallback")
    ENCODING_FALLBACK,
    /** The input was truncated due to size limits. */
    @com.fasterxml.jackson.annotation.JsonProperty("truncated_input")
    TRUNCATED_INPUT,
    /** The HTML was malformed but processing continued with best effort. */
    @com.fasterxml.jackson.annotation.JsonProperty("malformed_html")
    MALFORMED_HTML,
    /** Sanitization was applied to remove potentially unsafe content. */
    @com.fasterxml.jackson.annotation.JsonProperty("sanitization_applied")
    SANITIZATION_APPLIED,
    /** DOM traversal was truncated because max_depth was exceeded. */
    @com.fasterxml.jackson.annotation.JsonProperty("depth_limit_exceeded")
    ...
    companion object {
        ...
        @JvmStatic
        fun fromWire(value: String): WarningKind = when (value) {
            "image_extraction_failed" -> IMAGE_EXTRACTION_FAILED
            "encoding_fallback" -> ENCODING_FALLBACK
            "truncated_input" -> TRUNCATED_INPUT
            "malformed_html" -> MALFORMED_HTML
