...
extension ConversionOptionsUpdateRef {
    ...
    public func baseUrl() -> RustString {
        RustString(ptr: __swift_bridge__$ConversionOptionsUpdate$base_url(ptr))
    }
