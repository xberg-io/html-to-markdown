...
// alef:hash:860ee1c64703f25c2d7064821121225ab547740725d71895777a3b3e7dcc8531
...
/// ```
public struct ConversionResult: Codable, Sendable, Hashable {
    ...
    public let metadata: HtmlMetadata
    ...
    public let warnings: [ProcessingWarning]
    public init(content: String? = nil, document: DocumentStructure? = nil, metadata: HtmlMetadata, tables: [TableData], warnings: [ProcessingWarning]) {
    ...
    public init(from decoder: any Decoder) throws {
        ...
        self.document = try container.decodeIfPresent(DocumentStructure.self, forKey: .document) ?? nil
        self.metadata = try container.decode(HtmlMetadata.self, forKey: .metadata)
        self.tables = try container.decodeIfPresent([TableData].self, forKey: .tables) ?? []
        self.warnings = try container.decodeIfPresent([ProcessingWarning].self, forKey: .warnings) ?? []
    }
}

// MARK: - Internal FFI conversions for ConversionResult
internal extension ConversionResult {
    init(_ rb: RustBridge.ConversionResultRef) throws {
        self.content = rb.content()?.toString()
        self.document = try rb.document().map { try DocumentStructure($0) }
        self.metadata = try HtmlMetadata(rb.metadata())
        self.tables = try rb.tables().map { (s: RustStringRef) -> TableData in let d = s.as_str().toString().data(using: .utf8) ?? Data(); return try JSONDecoder().decode(TableData.self, from: d) }
        self.warnings = try rb.warnings().map { (s: RustStringRef) -> ProcessingWarning in let d = s.as_str().toString().data(using: .utf8) ?? Data(); return try JSONDecoder().decode(ProcessingWarning.self, from: d) }
    }

    func intoRust() throws -> RustBridge.ConversionResult {
...
public struct DocumentMetadata: Codable, Sendable, Hashable {
    ...
    public init(title: String? = nil, description: String? = nil, keywords: [String], author: String? = nil, canonicalUrl: String? = nil, baseHref: String? = nil, language: String? = nil, textDirection: TextDirection? = nil, openGraph: [String: String], twitterCard: [String: String], metaTags: [String: String]) {
        self.title = title
...
public struct DocumentNode: Codable, Sendable, Hashable {
    ...
    public init(id: String, content: NodeContent, parent: UInt32? = nil, children: [UInt32], annotations: [TextAnnotation], attributes: [String: String]? = nil) {
        self.id = id
        self.content = content
        self.parent = parent
...
public struct DocumentStructure: Codable, Sendable, Hashable {
    ...
    public init(nodes: [DocumentNode], sourceFormat: String? = nil) {
        self.nodes = nodes
    ...
    public init(from decoder: any Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.nodes = try container.decode([DocumentNode].self, forKey: .nodes)
...
public struct GridCell: Codable, Sendable, Hashable {
    ...
    public init(content: String, row: UInt32, col: UInt32, rowSpan: UInt32 = 1, colSpan: UInt32 = 1, isHeader: Bool) {
        self.content = content
        self.row = row
        self.col = col
...
public struct HtmlMetadata: Codable, Sendable, Hashable {
    ...
    public init(document: DocumentMetadata, headers: [HeaderMetadata], links: [LinkMetadata], images: [ImageMetadata], structuredData: [StructuredData]) {
        self.document = document
    ...
    public init(from decoder: any Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.document = try container.decode(DocumentMetadata.self, forKey: .document)
        ...
        self.images = try container.decodeIfPresent([ImageMetadata].self, forKey: .images) ?? []
...
internal extension HtmlMetadata {
    init(_ rb: RustBridge.HtmlMetadataRef) throws {
        self.document = try DocumentMetadata(rb.document())
        ...
        self.images = try rb.images().map { (s: RustStringRef) -> ImageMetadata in let d = s.as_str().toString().data(using: .utf8) ?? Data(); return try JSONDecoder().decode(ImageMetadata.self, from: d) }
    ...
    func intoRust() throws -> RustBridge.HtmlMetadata {
        let __headers = RustVec<RustBridge.HeaderMetadata>()
        for __elem in self.headers { __headers.push(value: try __elem.intoRust()) }
        let __links = RustVec<RustBridge.LinkMetadata>()
        for __elem in self.links { __links.push(value: try __elem.intoRust()) }
        let __images = RustVec<RustBridge.ImageMetadata>()
        for __elem in self.images { __images.push(value: try __elem.intoRust()) }
        let __structuredData = RustVec<RustBridge.StructuredData>()
        for __elem in self.structuredData { __structuredData.push(value: try __elem.intoRust()) }
        return RustBridge.HtmlMetadata(try self.document.intoRust(), __headers, __links, __images, __structuredData)
    }
}
...
public struct ImageMetadata: Codable, Sendable, Hashable {
    ...
    public let attributes: [String: String]
    public init(src: String, alt: String? = nil, title: String? = nil, dimensions: ImageDimensions? = nil, imageType: ImageType, attributes: [String: String]) {
        self.src = src
        self.alt = alt
        self.title = title
...
internal extension ImageMetadata {
    init(_ rb: RustBridge.ImageMetadataRef) throws {
        ...
        self.imageType = try { let rawValue = rb.imageType().toString(); guard let value = ImageType(rawValue: rawValue) else { throw ConversionError.validation(message: "Unknown ImageType variant", source: rawValue) }; return value }()
        self.attributes = try JSONDecoder().decode([String: String].self, from: ((rb.attributes().toString()).data(using: .utf8) ?? Data("null".utf8)))
    }
...
public struct LinkMetadata: Codable, Sendable, Hashable {
    ...
    /// Additional HTML attributes
    public let attributes: [String: String]
    public init(href: String, text: String, title: String? = nil, linkType: LinkType, rel: [String], attributes: [String: String]) {
        self.href = href
        self.text = text
        self.title = title
...
internal extension LinkMetadata {
    init(_ rb: RustBridge.LinkMetadataRef) throws {
        ...
        self.text = rb.text().toString()
        self.title = rb.title()?.toString()
        self.linkType = try { let rawValue = rb.linkType().toString(); guard let value = LinkType(rawValue: rawValue) else { throw ConversionError.validation(message: "Unknown LinkType variant", source: rawValue) }; return value }()
...
public typealias ConversionResultRef = RustBridge.ConversionResultRef

public typealias ConversionResultRefMut = RustBridge.ConversionResultRefMut
...
public enum VisitResult: Codable, Sendable, Hashable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        case "continue":
            self = .`continue`
        case "custom":
            self = .custom(field0: try container.decode(String.self, forKey: .output))
        case "skip":
            self = .skip
        case "preserve_html":
            self = .preserveHtml
        case "error":
            self = .error(field0: try container.decode(String.self, forKey: .output))
        default:
            throw DecodingError.dataCorruptedError(
                forKey: .type,
                in: container,
                debugDescription: "Unknown VisitResult tag: \(tag)"
            )
        }
    }
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        case .custom(let field0):
            try container.encode("custom", forKey: .type)
            try container.encode(field0, forKey: .output)
        case .skip:
            try container.encode("skip", forKey: .type)
        case .preserveHtml:
            try container.encode("preserve_html", forKey: .type)
        case .error(let field0):
...
private final class _HtmlVisitorProtocolAdapter: _SwiftHtmlVisitorBoxDelegate {
    ...
    func visitText(_ ctx: RustString, _ text: RustString) -> String {
        ...
        guard let ctxDecoded = ctxDecoded else { return "{}" }
...
private func visit_result_toJson(_ result: VisitResult) -> String {
    ...
    case .custom(let v): return "{\"type\":\"custom\",\"output\":\"\(jsonEscapeStr(v))\"}"
    case .skip: return "{\"type\":\"skip\"}"
    case .preserveHtml: return "{\"type\":\"preserve_html\"}"
    case .error(let v): return "{\"type\":\"error\",\"output\":\"\(jsonEscapeStr(v))\"}"
    }
}
...
public func convert(html: String, options: ConversionOptions? = nil) throws -> ConversionResult {
    ...
    let _rb = try RustBridge.convert(_rb_html, options)
    return try ConversionResult(_rb)
}
