...
# alef:hash:14ebbb12d32241ab1e26e99d97afd24169c4ee01a72ba693785778b789a17f93
...
def _to_rust_conversion_options(
    ...
    if isinstance(value, dict):
        if "heading_style" in value and value["heading_style"] is not None:
            value["heading_style"] = _coerce_enum(_rust.HeadingStyle, value["heading_style"])
        if "list_indent_type" in value and value["list_indent_type"] is not None:
            value["list_indent_type"] = _coerce_enum(_rust.ListIndentType, value["list_indent_type"])
        if "highlight_style" in value and value["highlight_style"] is not None:
            value["highlight_style"] = _coerce_enum(_rust.HighlightStyle, value["highlight_style"])
        if "whitespace_mode" in value and value["whitespace_mode"] is not None:
            value["whitespace_mode"] = _coerce_enum(_rust.WhitespaceMode, value["whitespace_mode"])
        if "newline_style" in value and value["newline_style"] is not None:
            value["newline_style"] = _coerce_enum(_rust.NewlineStyle, value["newline_style"])
        if "code_block_style" in value and value["code_block_style"] is not None:
            value["code_block_style"] = _coerce_enum(_rust.CodeBlockStyle, value["code_block_style"])
        if "link_style" in value and value["link_style"] is not None:
            value["link_style"] = _coerce_enum(_rust.LinkStyle, value["link_style"])
