...
# alef:hash:d59b0bf2d58696addbc5cea2c5618264e6f28be2c84ce0afc4d11b0bac43fffd
...
class ConversionOptions:
    ...
    def from_json(json_str: str) -> ConversionOptions:
        ...
        return _from_native_conversion_options(_html_to_markdown.ConversionOptions.from_json(json_str))
...
class DocumentMetadata:
    ...
    def from_json(json_str: str) -> DocumentMetadata:
        """Build a DocumentMetadata from a JSON string, via the native binding."""
        return _from_native_document_metadata(_html_to_markdown.DocumentMetadata.from_json(json_str))
...
class HtmlMetadata:
    ...
    def from_json(json_str: str) -> HtmlMetadata:
        ...
        return _from_native_html_metadata(_html_to_markdown.HtmlMetadata.from_json(json_str))
...
class PreprocessingOptions:
    ...
    def from_json(json_str: str) -> PreprocessingOptions:
        ...
        return _from_native_preprocessing_options(_html_to_markdown.PreprocessingOptions.from_json(json_str))
...
class TableData:
    ...
    def from_json(json_str: str) -> TableData:
        """Build a TableData from a JSON string, via the native binding."""
        return _from_native_table_data(_html_to_markdown.TableData.from_json(json_str))
...
class TableGrid:
    ...
    def from_json(json_str: str) -> TableGrid:
        ...
        return _from_native_table_grid(_html_to_markdown.TableGrid.from_json(json_str))
...
def _from_native_table_data(native: Any) -> TableData:
    """Build the public `TableData` dataclass from the native binding object."""
    return TableData(
        grid=_from_native_table_grid(native.grid),
