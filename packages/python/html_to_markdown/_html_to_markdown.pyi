...
# alef:hash:37dbe5d69f52adc116ab73f1f02b34669854b060ffbcaa2c424ba96251b0818a
...
class ConversionOptionsUpdate:
    ...
    def __init__(
        ...
        list_indent_type: ListIndentType | None = None,
        ...
        whitespace_mode: WhitespaceMode | None = None,
        ...
        newline_style: NewlineStyle | None = None,
        ...
        url_escape_style: UrlEscapeStyle | None = None,
        ...
        tier_strategy: TierStrategy | None = None,
        base_url: str | None = None,
        visitor: VisitorHandle | None = None,
    ) -> None: ...
    @staticmethod
    def from_json(json_str: str) -> ConversionOptionsUpdate: ...
...
class ConversionResult:
    ...
    @staticmethod
    def from_json(json_str: str) -> ConversionResult: ...
...
class MetadataEntry:
    ...
    @staticmethod
    def from_json(json_str: str) -> MetadataEntry: ...
...
class NodeContext:
    ...
    @staticmethod
    def from_json(json_str: str) -> NodeContext: ...
...
class PreprocessingOptionsUpdate:
    ...
    def __init__(
        ...
        preset: PreprocessingPreset | None = None,
        remove_navigation: bool | None = None,
        remove_forms: bool | None = None,
    ) -> None: ...
    @staticmethod
    def from_json(json_str: str) -> PreprocessingOptionsUpdate: ...

class ProcessingWarning:
    message: str
    kind: WarningKind
    def __init__(self, message: str, kind: WarningKind) -> None: ...
    @staticmethod
...
class TableData:
    ...
    @staticmethod
    def from_json(json_str: str) -> TableData: ...
...
class VisitResult:
    type: str
    @staticmethod
    def from_custom(value: str) -> VisitResult: ...
    @staticmethod
    def from_error(value: str) -> VisitResult: ...
    def __init__(self, value: dict[str, Any] | str | None = None, **kwargs: Any) -> None: ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
