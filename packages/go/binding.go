...
// alef:hash:4def54c68f592ad2c0c8e3e30d104456c08c3744b6dd73b6c420fd7995087925
...
// If linking fails with `cannot find -lhtml_to_markdown_ffi`, run `go run <module>/cmd/setup`.

/*
#cgo CFLAGS: -I${SRCDIR}/include
#cgo CFLAGS: -DHTM_FEATURE_INLINE_IMAGES=1 -DHTM_FEATURE_METADATA=1 -DHTM_FEATURE_TESTKIT=1 -DHTM_FEATURE_VISITOR=1
...
func lastError() error {
	...
	var message string
	if ctx := C.htm_last_error_context(); ctx != nil {
...
// Sealed interface -- use one of AnnotationKindBold, AnnotationKindItalic, AnnotationKindUnderline, AnnotationKindStrikethrough, AnnotationKindCode, AnnotationKindSubscript, AnnotationKindSuperscript, AnnotationKindHighlight, AnnotationKindLink.
...
// Sealed interface -- use one of NodeContentHeading, NodeContentParagraph, NodeContentList, NodeContentListItem, NodeContentTable, NodeContentImage, NodeContentCode, NodeContentQuote, NodeContentDefinitionList, NodeContentDefinitionItem, NodeContentRawBlock, NodeContentMetadataBlock, NodeContentGroup.
