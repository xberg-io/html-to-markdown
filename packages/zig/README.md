...
<!-- alef:hash:a6695c04e379cdf7505a36c90a850e53e6c46a2b23a88f99041a77ec54fb6941 -->
...
```bash
zig fetch --save https://github.com/xberg-io/html-to-markdown/releases/download/v3.14.0/zig.tar.gz
```
