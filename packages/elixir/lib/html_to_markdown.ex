...
# alef:hash:96227925e024d8d4cebd6ade1aa15179b9229e756fef80679791205c9cb035f7
...
defmodule HtmlToMarkdown do
  ...
  def convert(html, options) when is_map(options) do
    ...
    if is_map(visitor) do
      {:ok, _} = HtmlToMarkdown.Native.convert_with_visitor(html, if(map_size(clean_opts) == 0, do: nil, else: Jason.encode!(clean_opts)), visitor)
