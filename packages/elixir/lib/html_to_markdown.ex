...
defmodule HtmlToMarkdown do
  ...
  defp apply_visitor_callback(fun, args_json) do
    ...
    case result do      "Continue" -> "Continue"      :Continue -> "Continue"      "Skip" -> "Skip"      :Skip -> "Skip"      "PreserveHtml" -> "PreserveHtml"      :PreserveHtml -> "PreserveHtml"      {:custom, value} -> to_string(value)
