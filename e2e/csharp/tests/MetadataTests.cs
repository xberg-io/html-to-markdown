...
// alef:hash:19bf73681ec82a7828ac23265b4e5c32fa096686731b3e900d99e2861fe4b4ca
...
namespace HtmlToMarkdown
{
    ...
    public class MetadataTests
    {
        ...
        public void Test_MetadataAuthorMeta()
        {
            ...
            Assert.Equal("Jane Doe", result.Metadata.Document.Author);
        ...
        public void Test_MetadataCanonicalUrl()
        {
            ...
            Assert.Equal("https://example.com/canonical-page", result.Metadata.Document.CanonicalUrl);
        ...
        public void Test_MetadataDescriptionMeta()
        {
            ...
            Assert.Equal("This is the page description.", result.Metadata.Document.Description);
        ...
        public void Test_MetadataDublinCore()
        {
            ...
            Assert.Contains("scholarly article", result.Content.ToString());
        ...
        public void Test_MetadataLangAttribute()
        {
            ...
            Assert.Contains("Hola Mundo", result.Content.ToString());
        ...
        public void Test_MetadataMicrodataSchemaArticle()
        {
            ...
            Assert.Contains("Breaking News Today", result.Content.ToString());
            Assert.Contains("Jane Reporter", result.Content.ToString());
            Assert.Contains("important information", result.Content.ToString());
        ...
        public void Test_MetadataMicrodataSchemaBreadcrumb()
        {
            ...
            Assert.Contains("Home", result.Content.ToString());
            Assert.Contains("Products", result.Content.ToString());
            Assert.Contains("Current Page", result.Content.ToString());
        ...
        public void Test_MetadataMicrodataSchemaOrganization()
        {
            ...
            Assert.Contains("Acme Corp", result.Content.ToString());
            Assert.Contains("2020", result.Content.ToString());
        ...
        public void Test_MetadataMicrodataSchemaPerson()
        {
            ...
            Assert.Contains("John Smith", result.Content.ToString());
            Assert.Contains("john@example.com", result.Content.ToString());
        ...
        public void Test_MetadataMicrodataSchemaProduct()
        {
            ...
            Assert.Contains("Awesome Widget", result.Content.ToString());
            Assert.Contains("best widget", result.Content.ToString());
            Assert.Contains("29.99", result.Content.ToString());
        ...
        public void Test_MetadataTextDirectionLtr()
        {
            ...
            Assert.Contains("left-to-right text", result.Content.ToString());
        ...
        public void Test_MetadataTextDirectionRtl()
        {
            ...
            Assert.Contains("right-to-left text", result.Content.ToString());
        ...
        public void Test_MetadataTitleTag()
        {
            ...
            Assert.Equal("My Page", result.Metadata.Document.Title);
        ...
        public void Test_OgBasicTags()
        {
            ...
            Assert.Equal("OG Title", result.Metadata.Document.OpenGraph["title"]);
            Assert.Equal("OG description text.", result.Metadata.Document.OpenGraph["description"]);
            Assert.Equal("https://example.com/image.jpg", result.Metadata.Document.OpenGraph["image"]);
        ...
        public void Test_OgMultipleTags()
        {
            ...
            Assert.Equal("Article Title", result.Metadata.Document.OpenGraph["title"]);
            Assert.Equal("article", result.Metadata.Document.OpenGraph["type"]);
            Assert.Equal("https://example.com/article", result.Metadata.Document.OpenGraph["url"]);
            Assert.Equal("Example Site", result.Metadata.Document.OpenGraph["site_name"]);
        ...
        public void Test_StructuredDataJsonLd()
        {
            ...
            Assert.DoesNotContain("application/ld+json", result.Content.ToString());
            Assert.DoesNotContain("@context", result.Content.ToString());
            Assert.DoesNotContain("schema.org", result.Content.ToString());
        ...
        public void Test_StructuredDataMultipleJsonLd()
        {
            ...
            Assert.DoesNotContain("@context", result.Content.ToString());
            Assert.DoesNotContain("BreadcrumbList", result.Content.ToString());
            Assert.DoesNotContain("ListItem", result.Content.ToString());
        ...
        public void Test_TwitterCardTags()
        {
            ...
            Assert.Equal("summary_large_image", result.Metadata.Document.TwitterCard["card"]);
            Assert.Equal("Twitter Card Title", result.Metadata.Document.TwitterCard["title"]);
            Assert.Equal("Twitter card description.", result.Metadata.Document.TwitterCard["description"]);
