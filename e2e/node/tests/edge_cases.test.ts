...
describe("edge-cases", () => {
    ...
    visitCustomElement(ctx: any, tagName: any, html: any): string | { custom: string } {
		...
		const result = convert("<div><custom-widget data-value=\"123\"><p>Widget content here</p><span>With nested elements</span></custom-widget></div>", undefined, _testVisitor);
    ...
    visitMark(ctx: any, text: any): string | { custom: string } {
		...
		const result = convert("<div><p>Outer <em>emphasis <strong>with bold <mark>and highlight</mark></strong></em> text</p></div>", undefined, _testVisitor);
    ...
    visitCustomElement(ctx: any, tagName: any, html: any): string | { custom: string } {
		...
		const result = convert("<article><p>Article text</p><x-custom>Custom element with content</x-custom><p>More article text</p></article>", undefined, _testVisitor);
