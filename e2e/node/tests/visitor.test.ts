...
describe("visitor", () => {
    ...
    visitAudio(ctx: any, src: any): string | { custom: string } {
		...
		const result = convert("<p>Listen to this: <audio src=\"podcast.mp3\" controls></audio></p>", undefined, _testVisitor);
    ...
    visitAudio(ctx: any, src: any): string | { custom: string } {
		...
		const result = convert("<p>Background music:</p><audio src=\"music.ogg\" autoplay></audio><p>Enjoy!</p>", undefined, _testVisitor);
    ...
    visitButton(ctx: any, text: any): string | { custom: string } {
		...
		const result = convert("<p>Confirm action: <button type=\"submit\">Click me</button> or <button type=\"reset\">Cancel</button></p>", undefined, _testVisitor);
    ...
    visitButton(ctx: any, text: any): string | { custom: string } {
		...
		const result = convert("<p>Actions available: <button>Save</button> <button>Delete</button> <button>Export</button></p>", undefined, _testVisitor);
    ...
    visitLink(ctx: any, href: any, text: any, title: any): string | { custom: string } {
		...
		const result = convert("<p>Visit <a href=\"https://example.com\">Example</a> for more info.</p>", undefined, _testVisitor);
    ...
    visitDefinitionTerm(ctx: any, text: any): string | { custom: string } {
		...
		const result = convert("<dl><dt>HTML</dt><dd>HyperText Markup Language</dd><dt>CSS</dt><dd>Cascading Style Sheets</dd></dl>", undefined, _testVisitor);
    ...
    visitDefinitionTerm(ctx: any, text: any): string | { custom: string } {
		...
		const result = convert("<dl><dt>Python</dt><dd>A high-level programming language</dd><dt>JavaScript</dt><dd>A scripting language for web browsers</dd></dl>", undefined, _testVisitor);
    ...
    visitDefinitionTerm(ctx: any, text: any): string | { custom: string } {
		...
		const result = convert("<p>Glossary:</p><dl><dt>Term A</dt><dd>Definition of term A</dd><dt>Term B</dt><dd>Definition of term B</dd></dl><p>End of glossary</p>", undefined, _testVisitor);
    ...
    visitSummary(ctx: any, text: any): string | { custom: string } {
		...
		const result = convert("<details><summary>Click to expand</summary><p>This content is initially hidden.</p><p>But can be revealed by the user.</p></details>", undefined, _testVisitor);
    ...
    visitDetails(ctx: any, isOpen: any): string | { custom: string } {
		...
		const result = convert("<p>Main content here.</p><details><summary>Hidden section</summary><p>Secret details</p></details><p>More main content.</p>", undefined, _testVisitor);
    ...
    visitFigcaption(ctx: any, text: any): string | { custom: string } {
		...
		const result = convert("<article><h1>Article Title</h1><p>Introduction paragraph.</p><figure><img src=\"diagram.png\" alt=\"System architecture diagram\"><figcaption>Figure 1: System Architecture</figcaption></figure><p>Explanation of the figure.</p></article>", undefined, _testVisitor);
...
` };
    ...
    visitFigureStart(ctx: any): string | { custom: string } {
		...
		const result = convert("<section><h2>Gallery</h2><figure><img src=\"photo1.jpg\" alt=\"Photo\"><figcaption>Beautiful sunset</figcaption></figure></section>", undefined, _testVisitor);
    ...
    visitFigureStart(ctx: any): string | { custom: string } {
		...
		const result = convert("<p>See the chart below:</p><figure><img src=\"chart.svg\"><figcaption>Revenue Trends 2020-2024</figcaption></figure><p>As shown in the chart above.</p>", undefined, _testVisitor);
    ...
    visitForm(ctx: any, actionUrl: any, method: any): string | { custom: string } {
		...
		const result = convert("<div><form action=\"/submit\" method=\"POST\"><label>Name: <input type=\"text\" name=\"name\"></label><button type=\"submit\">Submit</button></form></div>", undefined, _testVisitor);
    ...
    visitForm(ctx: any, actionUrl: any, method: any): string | { custom: string } {
		...
		const result = convert("<p>Before form</p><form><input type=\"email\" name=\"email\"></form><p>After form</p>", undefined, _testVisitor);
    ...
    visitHorizontalRule(ctx: any): string | { custom: string } {
		...
		const result = convert("<h1>Section A</h1><p>Content A</p><hr><h1>Section B</h1><p>Content B</p>", undefined, _testVisitor);
    ...
    visitIframe(ctx: any, src: any): string | { custom: string } {
		...
		const result = convert("<p>Embedded map:</p><iframe src=\"https://maps.example.com/embed\" width=\"400\" height=\"300\"></iframe><p>End of map</p>", undefined, _testVisitor);
    ...
    visitIframe(ctx: any, src: any): string | { custom: string } {
		...
		const result = convert("<h3>Reviews</h3><iframe src=\"https://widget.example.com/reviews\"></iframe><p>See reviews from our partners.</p>", undefined, _testVisitor);
    ...
    visitInput(ctx: any, input_type: any, name: any, value: any): string | { custom: string } {
		...
		const result = convert("<form><label>Username: <input type=\"text\" name=\"username\" value=\"\"></label><label>Password: <input type=\"password\" name=\"password\"></label></form>", undefined, _testVisitor);
    ...
    visitInput(ctx: any, input_type: any, name: any, value: any): string | { custom: string } {
		...
		const result = convert("<p>Sign up:</p><input type=\"text\" name=\"email\" placeholder=\"your@email.com\"><input type=\"checkbox\" name=\"agree\"><p>Continue</p>", undefined, _testVisitor);
    ...
    visitMark(ctx: any, text: any): string | { custom: string } {
		...
		const result = convert("<p>This is a <mark>highlighted passage</mark> in the text.</p>", undefined, _testVisitor);
    ...
    visitMark(ctx: any, text: any): string | { custom: string } {
		...
		const result = convert("<p>Key insight: <mark>always validate input</mark> for security.</p>", undefined, _testVisitor);
    ...
    visitCodeBlock(ctx: any, lang: any, code: any): string | { custom: string } {
		...
		const result = convert("<p>Intro text</p><pre><code>let x = 42;</code></pre><p>Outro text</p>", undefined, _testVisitor);
    ...
    visitImage(ctx: any, src: any, alt: any, title: any): string | { custom: string } {
		...
		const result = convert("<p>Before image</p><img src=\"photo.jpg\" alt=\"A photo\"><p>After image</p>", undefined, _testVisitor);
    ...
    visitLink(ctx: any, href: any, text: any, title: any): string | { custom: string } {
		...
		const result = convert("<p>Before <a href=\"https://example.com\">link text</a> after</p>", undefined, _testVisitor);
    ...
    visitSubscript(ctx: any, text: any): string | { custom: string } {
		...
		const result = convert("<p>The formula C<sub>12</sub>H<sub>22</sub>O<sub>11</sub> is sugar.</p>", undefined, _testVisitor);
    ...
    visitSuperscript(ctx: any, text: any): string | { custom: string } {
		...
		const result = convert("<p>The equation x<sup>3</sup> + y<sup>3</sup> = z<sup>3</sup> has no solutions.</p>", undefined, _testVisitor);
    ...
    visitUnderline(ctx: any, text: any): string | { custom: string } {
		...
		const result = convert("<p>Normal text with <u>underlined part</u> and more text.</p>", undefined, _testVisitor);
    ...
    visitVideo(ctx: any, src: any): string | { custom: string } {
		...
		const result = convert("<p>Watch our tutorial:</p><video src=\"tutorial.mp4\" width=\"320\" height=\"240\" controls></video><p>Great content!</p>", undefined, _testVisitor);
    ...
    visitVideo(ctx: any, src: any): string | { custom: string } {
		...
		const result = convert("<h2>Demo</h2><video src=\"demo.webm\"></video><p>See the demo above.</p>", undefined, _testVisitor);
