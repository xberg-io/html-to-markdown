...
// alef:hash:53ed02d413dbbb3af7646a6f33fe279ee176de54066869c489164e152e338416
...
void test_result_tables_empty_when_no_tables(void) {
    ...
    HTMConvert* result = htm_convert("<p>No tables here</p>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_convert_content(result);
    char* tables = htm_convert_tables(result);
...
void test_result_tables_multiple(void) {
    ...
    HTMConversionOptions* options_handle = htm_conversion_options_from_json("{\"include_document_structure\":true}");
    HTMConvert* result = htm_convert("<table><tr><th>A</th></tr><tr><td>1</td></tr></table><p>Between</p><table><tr><th>B</th></tr><tr><td>2</td></tr></table>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* tables = htm_convert_tables(result);
    {
...
void test_result_tables_simple(void) {
    ...
    HTMConversionOptions* options_handle = htm_conversion_options_from_json("{\"include_document_structure\":true}");
    HTMConvert* result = htm_convert("<table><thead><tr><th>Name</th><th>Age</th></tr></thead><tbody><tr><td>Alice</td><td>30</td></tr></tbody></table>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_convert_content(result);
    char* tables = htm_convert_tables(result);
    assert(strlen(content) > 0 && "expected non-empty value");
...
void test_result_tables_without_structure_flag(void) {
    ...
    HTMConvert* result = htm_convert("<table><tr><th>X</th></tr><tr><td>Y</td></tr></table>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_convert_content(result);
    char* tables = htm_convert_tables(result);
    assert(strlen(content) > 0 && "expected non-empty value");
...
void test_result_warnings_empty_for_clean_input(void) {
    ...
    HTMConvert* result = htm_convert("<h1>Title</h1><p>Clean content with <a href='https://example.com'>a link</a>.</p>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_convert_content(result);
    char* warnings = htm_convert_warnings(result);
    assert(strlen(content) > 0 && "expected non-empty value");
    {
        /* count_equals: count elements in array */
...
void test_result_warnings_empty_for_complex_input(void) {
    ...
    HTMConvert* result = htm_convert("<article><h1>Article</h1><p>Paragraph with <strong>bold</strong> and <em>italic</em>.</p><table><tr><th>Col</th></tr><tr><td>Val</td></tr></table><ul><li>Item 1</li><li>Item 2</li></ul></article>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_convert_content(result);
    char* warnings = htm_convert_warnings(result);
    assert(strlen(content) > 0 && "expected non-empty value");
...
void test_result_warnings_empty_for_malformed_html(void) {
    ...
    HTMConvert* result = htm_convert("<p>Unclosed paragraph<div>Mixed nesting</p></div>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_convert_content(result);
    char* warnings = htm_convert_warnings(result);
    assert(strlen(content) > 0 && "expected non-empty value");
