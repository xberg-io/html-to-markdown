...
// alef:hash:ad3c76653cc573de2bf0d0aed3d526c2b926e7b2661fce8a50d12c5ad1b96e4a
...
void test_empty_html(void) {
    /* Empty HTML document */
    HTMConvert* result = htm_convert("<html><head></head><body></body></html>", NULL);
...
void test_encoding_cjk_characters(void) {
    ...
    HTMConvert* result = htm_convert("<p>中文内容</p><p>日本語テキスト</p><p>한국어 텍스트</p>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_convert_content(result);
...
void test_encoding_html_entities(void) {
    ...
    HTMConvert* result = htm_convert("<p>&amp; &lt; &gt; &nbsp; &quot; &apos;</p>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_convert_content(result);
    assert(strlen(content) > 0 && "expected non-empty value");
...
void test_encoding_named_entities(void) {
    ...
    HTMConvert* result = htm_convert("<p>Em dash&mdash;used for parenthetical remarks&mdash;is common. Ellipsis&hellip; indicates omission. Non-breaking&nbsp;space.</p>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_convert_content(result);
    assert(strlen(content) > 0 && "expected non-empty value");
    assert(strstr(content, "—") != NULL && "expected to contain substring");
...
void test_encoding_numeric_entities(void) {
    ...
    HTMConvert* result = htm_convert("<p>Copyright: &#169; Trade: &#174; Euro: &#8364; Hex: &#x00A9;</p>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_convert_content(result);
    assert(strlen(content) > 0 && "expected non-empty value");
    assert(strstr(content, "©") != NULL && "expected to contain substring");
...
void test_encoding_unicode_emoji(void) {
    ...
    HTMConvert* result = htm_convert("<p>Hello 🌍 World 🚀</p><p>Stars: ⭐ ✨</p>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_convert_content(result);
    assert(strlen(content) > 0 && "expected non-empty value");
    assert(strstr(content, "🌍") != NULL && "expected to contain substring");
...
void test_html_comments_only(void) {
    ...
    HTMConvert* result = htm_convert("<!-- This is a comment --><!-- Another comment -->", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_convert_content(result);
    assert(str_trim_eq(content, "") == 0 && "equals assertion failed");
    htm_free_string(content);
...
void test_malformed_deeply_nested_elements(void) {
    ...
    HTMConvert* result = htm_convert("<div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><div><p>Deeply nested content</p></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_convert_content(result);
    assert(strlen(content) > 0 && "expected non-empty value");
...
void test_malformed_missing_block_closing_tags(void) {
    ...
    HTMConvert* result = htm_convert("<div><h1>Title<p>First paragraph<p>Second paragraph</div>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_convert_content(result);
    assert(strlen(content) > 0 && "expected non-empty value");
...
void test_malformed_overlapping_tags(void) {
    ...
    HTMConvert* result = htm_convert("<p><b><i>bold and italic</b></i></p>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_convert_content(result);
    assert(strlen(content) > 0 && "expected non-empty value");
...
void test_malformed_unclosed_paragraph(void) {
    ...
    HTMConvert* result = htm_convert("<p>This paragraph is never closed", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_convert_content(result);
    assert(strlen(content) > 0 && "expected non-empty value");
...
void test_script_tags_only(void) {
    ...
    HTMConvert* result = htm_convert("<html><head><script>alert('xss')</script></head><body><script>document.write('hello')</script></body></html>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_convert_content(result);
    assert(str_trim_eq(content, "") == 0 && "equals assertion failed");
    htm_free_string(content);
...
void test_style_tags_only(void) {
    ...
    HTMConvert* result = htm_convert("<html><head><style>body { color: red; }</style></head><body><style>.foo { margin: 0; }</style></body></html>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_convert_content(result);
    assert(str_trim_eq(content, "") == 0 && "equals assertion failed");
    htm_free_string(content);
...
void test_xss_onclick_handler_removed(void) {
    ...
    HTMConvert* result = htm_convert("<p><a href=\"https://example.com\" onclick=\"alert('xss')\">Click me</a></p><button onmouseover=\"steal_data()\">Hover me</button>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_convert_content(result);
    assert(strlen(content) > 0 && "expected non-empty value");
...
void test_xss_script_tag_stripped(void) {
    ...
    HTMConvert* result = htm_convert("<p>Safe content.</p><script>alert('xss')</script><p>More safe content.</p>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_convert_content(result);
    assert(strlen(content) > 0 && "expected non-empty value");
...
void test_xss_svg_nested_script_stripped(void) {
    ...
    HTMConvert* result = htm_convert("<p>Before SVG.</p><svg xmlns=\"http://www.w3.org/2000/svg\"><script>alert('svg-xss')</script><text>SVG text</text></svg><p>After SVG.</p>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_convert_content(result);
    assert(strlen(content) > 0 && "expected non-empty value");
