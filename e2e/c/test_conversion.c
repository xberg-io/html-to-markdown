...
// alef:hash:dd8ccab9d7b6842be49cdc10a474933400141fbf2cd527f18f9010771c830cc7
...
void test_list_item_multiple_paragraphs(void) {
    ...
    HTMHtmConvert *result = htm_convert("<ul><li><p>First paragraph in item.</p><p>Second "
                                        "paragraph in item.</p></li><li>Simple item</li></ul>",
                                        NULL);
    assert(result != NULL && "expected call to succeed");
    char *content = htm_htm_convert_content(result);
...
void test_paragraph_with_inline_formatting(void) {
    ...
    HTMHtmConvert *result = htm_convert("<p>This has <strong>bold</strong>, <em>italic</em>, and a "
...
void test_table_no_thead(void) {
    ...
    HTMHtmConvert *result = htm_convert("<table><tr><td>Product</td><td>Price</td></"
