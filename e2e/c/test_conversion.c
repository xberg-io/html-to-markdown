...
// alef:hash:2f5e1e2f15692fd6cb4b56c9ff9880e74405bec06567ef148210b3a46f03da63
...
void test_form_input_elements(void) {
    ...
    HTMConvert *result = htm_convert("<form><label for=\"name\">Name:</label><input type=\"text\" "
...
void test_list_item_multiple_paragraphs(void) {
    ...
    HTMConvert *result = htm_convert("<ul><li><p>First paragraph in item.</p><p>Second paragraph "
...
void test_paragraph_with_inline_formatting(void) {
    ...
    HTMConvert *result = htm_convert("<p>This has <strong>bold</strong>, <em>italic</em>, and a <a "
...
void test_table_no_thead(void) {
    ...
    HTMConvert *result = htm_convert("<table><tr><td>Product</td><td>Price</td></tr><tr><td>Apple</"
