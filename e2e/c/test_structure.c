...
// alef:hash:0c62ce9c029b30d8e36ada8eeab9762159b1758692beb82507b735638e12bf7c
...
void test_structure_code_block(void) {
    ...
    HTMConvert *result = htm_convert("<p>Example code:</p><pre><code class=\"language-rust\">fn "
...
void test_structure_deep_nesting_h1_h2_h3(void) {
    ...
    HTMConversionOptions *options_handle =
        htm_conversion_options_from_json("{\"include_document_structure\":true}");
    HTMConvert *result = htm_convert("<h1>Top Level</h1><p>Top intro.</p><h2>Mid Level</h2><p>Mid "
...
void test_structure_multiple_headings(void) {
    ...
    HTMConversionOptions *options_handle =
        htm_conversion_options_from_json("{\"include_document_structure\":true}");
    HTMConvert *result = htm_convert("<h1>Main Title</h1><h2>Section One</h2><p>Section one "
