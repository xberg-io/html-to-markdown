...
// alef:hash:dc0db44a4516638202a92c53a3f3a2e909499bd07626cdca914fc7f538855b4f
...
void test_structure_code_block(void) {
    ...
    HTMConvert* result = htm_convert("<p>Example code:</p><pre><code class=\"language-rust\">fn main() { println!(\"Hello\"); }</code></pre>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_convert_content(result);
    HTMDocument* document_handle = htm_convert_document(result);
...
void test_structure_deep_nesting_h1_h2_h3(void) {
    ...
    HTMConversionOptions* options_handle = htm_conversion_options_from_json("{\"include_document_structure\":true}");
    HTMConvert* result = htm_convert("<h1>Top Level</h1><p>Top intro.</p><h2>Mid Level</h2><p>Mid content.</p><h3>Deep Level</h3><p>Deep content.</p>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_convert_content(result);
    HTMDocument* document_handle = htm_convert_document(result);
    assert(document_handle != NULL);
...
void test_structure_h1_h2_nested_group(void) {
    ...
    HTMConversionOptions* options_handle = htm_conversion_options_from_json("{\"include_document_structure\":true}");
    HTMConvert* result = htm_convert("<h1>Chapter One</h1><p>Chapter intro.</p><h2>Section One</h2><p>Section content.</p>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_convert_content(result);
    HTMDocument* document_handle = htm_convert_document(result);
    assert(document_handle != NULL);
...
void test_structure_heading_paragraph(void) {
    ...
    HTMConversionOptions* options_handle = htm_conversion_options_from_json("{\"include_document_structure\":true}");
    HTMConvert* result = htm_convert("<h1>Title</h1><p>A paragraph of text.</p>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_convert_content(result);
    HTMDocument* document_handle = htm_convert_document(result);
    assert(document_handle != NULL);
...
void test_structure_list(void) {
    ...
    HTMConversionOptions* options_handle = htm_conversion_options_from_json("{\"include_document_structure\":true}");
    HTMConvert* result = htm_convert("<p>Items:</p><ul><li>Alpha</li><li>Beta</li><li>Gamma</li></ul>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_convert_content(result);
    HTMDocument* document_handle = htm_convert_document(result);
    assert(document_handle != NULL);
...
void test_structure_multiple_headings(void) {
    ...
    HTMConversionOptions* options_handle = htm_conversion_options_from_json("{\"include_document_structure\":true}");
    HTMConvert* result = htm_convert("<h1>Main Title</h1><h2>Section One</h2><p>Section one content.</p><h2>Section Two</h2><p>Section two content.</p>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_convert_content(result);
    HTMDocument* document_handle = htm_convert_document(result);
    assert(document_handle != NULL);
...
void test_structure_sibling_h1_groups(void) {
    ...
    HTMConversionOptions* options_handle = htm_conversion_options_from_json("{\"include_document_structure\":true}");
    HTMConvert* result = htm_convert("<h1>Chapter One</h1><h2>Section A</h2><p>Section A content.</p><h1>Chapter Two</h1><h2>Section B</h2><p>Section B content.</p>", options_handle);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_convert_content(result);
    HTMDocument* document_handle = htm_convert_document(result);
    assert(document_handle != NULL);
