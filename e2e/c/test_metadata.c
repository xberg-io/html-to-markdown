 ...
 * alef:hash:004556a9ea2b9868355432b0fbcd63a5f0fb4b1d77e54b2d8d4a898be49d0520
...
void test_metadata_author_meta(void) {
  ...
  HTMAlefHandle result = htm_convert(
      "<html><head><title>Page</title><meta name=\"author\" content=\"Jane "
  ...
  assert(metadata_author != NULL && strcmp(metadata_author, "Jane Doe") == 0 &&
...
void test_metadata_canonical_url(void) {
  ...
  HTMAlefHandle result =
      htm_convert("<html><head><title>Page</title><link rel=\"canonical\" "
                  "href=\"https://example.com/canonical-page\"></"
  ...
  HTMAlefHandle document_handle = htm_html_metadata_document(metadata_handle);
  assert(document_handle != 0);
  char *metadata_canonical_url =
      htm_document_metadata_canonical_url(document_handle);
  assert(content != NULL && strlen(content) > 0 && strcmp(content, "[]") != 0 &&
         strcmp(content, "{}") != 0 && "expected non-empty value");
  assert(metadata_canonical_url != NULL &&
         strcmp(metadata_canonical_url, "https://example.com/canonical-page") ==
             0 &&
         "equals assertion failed");
  htm_free_string(content);
...
void test_metadata_description_meta(void) {
  ...
  HTMAlefHandle options_handle =
      htm_conversion_options_from_json("{\"extract_metadata\":true}");
  HTMAlefHandle result =
      htm_convert("<html><head><title>Page</title><meta name=\"description\" "
                  "content=\"This is the page "
                  "description.\"></head><body><p>Content</p></body></html>",
                  options_handle);
  assert(result != 0 && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
  HTMAlefHandle metadata_handle = htm_conversion_result_metadata(result);
  ...
  assert(metadata_description != NULL &&
         strcmp(metadata_description, "This is the page description.") == 0 &&
         "equals assertion failed");
  htm_free_string(content);
...
void test_metadata_dublin_core(void) {
  ...
  HTMAlefHandle options_handle =
      htm_conversion_options_from_json("{\"extract_metadata\":true}");
  HTMAlefHandle result = htm_convert(
      "<html><head><title>Scholarly Work</title><meta name=\"DC.title\" "
      "content=\"Principles of Knowledge Management\"><meta "
      "name=\"DC.creator\" content=\"Dr. Alice Johnson\"><meta "
      "name=\"DC.date\" content=\"2023-06-15\"><meta name=\"DC.subject\" "
      "content=\"Knowledge Management\"><meta name=\"DC.publisher\" "
      "content=\"Academic Press\"></head><body><p>This is a scholarly "
      "article.</p></body></html>",
      options_handle);
  assert(result != 0 && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
...
void test_metadata_extract_all_images(void) {
  ...
  HTMAlefHandle options_handle =
      htm_conversion_options_from_json("{\"extract_metadata\":true}");
  HTMAlefHandle result = htm_convert(
      "<html><head><title>Gallery</title></head><body><img "
...
void test_metadata_extract_all_links(void) {
  ...
  HTMAlefHandle options_handle =
      htm_conversion_options_from_json("{\"extract_metadata\":true}");
  HTMAlefHandle result = htm_convert(
      "<html><head><title>Links Page</title></head><body><p>Visit <a "
...
void test_metadata_headers_hierarchy(void) {
  ...
  HTMAlefHandle options_handle =
      htm_conversion_options_from_json("{\"extract_metadata\":true}");
  HTMAlefHandle result = htm_convert(
      "<html><head><title>Docs</title></head><body><h1>Introduction</"
      "h1><h2>Getting "
...
void test_metadata_image_type_data_uri_classified(void) {
  /* A data-URI image is extracted into metadata.images when extract_metadata is
   * true */
  HTMAlefHandle options_handle =
      htm_conversion_options_from_json("{\"extract_metadata\":true}");
  HTMAlefHandle result = htm_convert(
...
void test_metadata_image_type_external_classified(void) {
  /* An https image URL is extracted into metadata.images when extract_metadata
   * is true */
  HTMAlefHandle options_handle =
      htm_conversion_options_from_json("{\"extract_metadata\":true}");
  HTMAlefHandle result = htm_convert(
...
void test_metadata_keywords_meta(void) {
  ...
  HTMAlefHandle options_handle =
      htm_conversion_options_from_json("{\"extract_metadata\":true}");
  HTMAlefHandle result = htm_convert(
      "<html><head><title>Page</title><meta name=\"keywords\" content=\"rust, "
  ...
  HTMAlefHandle document_handle = htm_html_metadata_document(metadata_handle);
  assert(document_handle != 0);
  char *metadata_document_keywords =
      htm_document_metadata_keywords(document_handle);
  assert(content != NULL && strlen(content) > 0 && strcmp(content, "[]") != 0 &&
         strcmp(content, "{}") != 0 && "expected non-empty value");
  {
    /* count_min: count top-level JSON array elements */
    assert(metadata_document_keywords != NULL &&
           "expected non-null collection JSON");
...
void test_metadata_lang_attribute(void) {
  ...
  HTMAlefHandle options_handle =
      htm_conversion_options_from_json("{\"extract_metadata\":true}");
  HTMAlefHandle result =
      htm_convert("<html lang=\"es\"><head><title>Spanish "
                  "Page</title></head><body><h1>Hola Mundo</h1><p>Este es un "
                  "documento en español.</p></body></html>",
                  options_handle);
  assert(result != 0 && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
  assert(content != NULL && strlen(content) > 0 && strcmp(content, "[]") != 0 &&
...
void test_metadata_link_type_anchor_classified(void) {
  /* A fragment anchor link is extracted into metadata.links when
   * extract_metadata is true */
  HTMAlefHandle options_handle =
      htm_conversion_options_from_json("{\"extract_metadata\":true}");
  HTMAlefHandle result = htm_convert(
      "<p>Jump to <a href=\"#section\">section</a> below.</p>", options_handle);
  assert(result != 0 && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
  HTMAlefHandle metadata_handle = htm_conversion_result_metadata(result);
  assert(metadata_handle != 0);
...
void test_metadata_link_type_email_classified(void) {
  /* A mailto link is extracted into metadata.links when extract_metadata is
   * true */
  HTMAlefHandle options_handle =
      htm_conversion_options_from_json("{\"extract_metadata\":true}");
  HTMAlefHandle result = htm_convert(
...
void test_metadata_link_type_external_classified(void) {
  /* An https link is extracted into metadata.links when extract_metadata is
   * true */
  HTMAlefHandle options_handle =
      htm_conversion_options_from_json("{\"extract_metadata\":true}");
  HTMAlefHandle result = htm_convert(
...
void test_metadata_microdata_schema_article(void) {
  ...
  HTMAlefHandle options_handle =
      htm_conversion_options_from_json("{\"extract_metadata\":true}");
  HTMAlefHandle result =
      htm_convert("<html><head><title>Article</title></head><body><article "
                  "itemscope itemtype=\"https://schema.org/Article\"><h1 "
                  "itemprop=\"headline\">Breaking News Today</h1><span "
                  "itemprop=\"author\">Jane Reporter</span><span "
                  "itemprop=\"datePublished\">2024-04-22</span><div "
                  "itemprop=\"articleBody\"><p>The article content goes here "
                  "with important information about the breaking news "
                  "story.</p></div></article></body></html>",
                  options_handle);
  assert(result != 0 && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
  assert(content != NULL && strlen(content) > 0 && strcmp(content, "[]") != 0 &&
...
void test_metadata_microdata_schema_breadcrumb(void) {
  ...
  HTMAlefHandle options_handle = htm_conversion_options_from_json(
      "{\"extract_metadata\":true,\"preprocessing\":{\"remove_navigation\":"
      "false}}");
  HTMAlefHandle result = htm_convert(
      ...
      "href=\"https://example.com\"><span "
      "itemprop=\"name\">Home</span></a></span><span "
      "itemprop=\"itemListElement\" itemscope "
      "itemtype=\"https://schema.org/ListItem\"><a itemprop=\"item\" "
      "href=\"https://example.com/products\"><span "
      "itemprop=\"name\">Products</span></a></span><span "
      "itemprop=\"itemListElement\" itemscope "
      "itemtype=\"https://schema.org/ListItem\"><span "
      "itemprop=\"name\">Current Page</span></span></nav></body></html>",
      options_handle);
  assert(result != 0 && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
  assert(content != NULL && strlen(content) > 0 && strcmp(content, "[]") != 0 &&
         strcmp(content, "{}") != 0 && "expected non-empty value");
  assert(content != NULL && strstr(content, "Home") != NULL &&
         "expected to contain substring");
...
void test_metadata_microdata_schema_organization(void) {
  ...
  HTMAlefHandle result = htm_convert(
      ...
      "itemprop=\"name\">Acme Corp</span><span "
      "itemprop=\"foundingDate\">2020</span><span "
      "itemprop=\"url\">https://acmecorp.example.com</span><span "
      "itemprop=\"logo\">https://acmecorp.example.com/logo.png</span></div></"
      "body></html>",
      options_handle);
  assert(result != 0 && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
  ...
  assert(content != NULL && strstr(content, "Acme Corp") != NULL &&
         "expected to contain substring");
  assert(content != NULL && strstr(content, "2020") != NULL &&
         "expected to contain substring");
  htm_free_string(content);
  htm_conversion_options_free(options_handle);
  htm_conversion_result_free(result);
...
void test_metadata_microdata_schema_person(void) {
  ...
  HTMAlefHandle options_handle =
      htm_conversion_options_from_json("{\"extract_metadata\":true}");
  HTMAlefHandle result = htm_convert(
      "<html><head><title>Contact</title></head><body><div itemscope "
...
void test_metadata_microdata_schema_product(void) {
  ...
  HTMAlefHandle result = htm_convert(
      ...
      "itemtype=\"https://schema.org/Product\"><h1 itemprop=\"name\">Awesome "
      "Widget</h1><span itemprop=\"description\">The best widget on the "
      "market</span><span itemprop=\"price\">29.99</span><span "
      "itemprop=\"priceCurrency\">USD</span><img itemprop=\"image\" "
      "src=\"widget.jpg\" alt=\"Widget\"><span "
  ...
  assert(content != NULL && strstr(content, "best widget") != NULL &&
         "expected to contain substring");
  assert(content != NULL && strstr(content, "29.99") != NULL &&
         "expected to contain substring");
  htm_free_string(content);
  htm_conversion_options_free(options_handle);
  htm_conversion_result_free(result);
...
void test_metadata_text_direction_ltr(void) {
  ...
  HTMAlefHandle result =
      htm_convert("<html lang=\"en\" dir=\"ltr\"><head><title>LTR "
                  "Document</title></head><body><p>This is left-to-right "
                  "text.</p></body></html>",
                  options_handle);
  assert(result != 0 && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
...
void test_metadata_text_direction_rtl(void) {
  ...
  HTMAlefHandle result =
      htm_convert("<html lang=\"ar\" dir=\"rtl\"><head><title>RTL "
                  "Document</title></head><body><p>This is right-to-left "
                  "text.</p></body></html>",
                  options_handle);
  assert(result != 0 && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
...
void test_metadata_title_tag(void) {
  ...
  HTMAlefHandle options_handle =
      htm_conversion_options_from_json("{\"extract_metadata\":true}");
  HTMAlefHandle result =
      htm_convert("<html><head><title>My "
                  "Page</title></head><body><p>Content</p></body></html>",
                  options_handle);
  assert(result != 0 && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
  HTMAlefHandle metadata_handle = htm_conversion_result_metadata(result);
  ...
  assert(content != NULL && strlen(content) > 0 && strcmp(content, "[]") != 0 &&
         strcmp(content, "{}") != 0 && "expected non-empty value");
  assert(metadata_title != NULL && strcmp(metadata_title, "My Page") == 0 &&
         "equals assertion failed");
  htm_free_string(content);
...
void test_og_basic_tags(void) {
  ...
  HTMAlefHandle result = htm_convert(
      "<html><head><title>Fallback Title</title><meta property=\"og:title\" "
      "content=\"OG Title\"><meta property=\"og:description\" content=\"OG "
      "description text.\"><meta property=\"og:image\" "
      "content=\"https://example.com/image.jpg\"></head><body><p>Content</p></"
      "body></html>",
      0);
  assert(result != 0 && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
  ...
  char *metadata_open_graph_title =
      alef_json_get_string(open_graph_json, "title");
  char *metadata_open_graph_description =
      alef_json_get_string(open_graph_json, "description");
  char *metadata_open_graph_image =
      alef_json_get_string(open_graph_json, "image");
  assert(content != NULL && strlen(content) > 0 && strcmp(content, "[]") != 0 &&
         strcmp(content, "{}") != 0 && "expected non-empty value");
  assert(metadata_open_graph_title != NULL &&
         strcmp(metadata_open_graph_title, "OG Title") == 0 &&
         "equals assertion failed");
  assert(metadata_open_graph_description != NULL &&
         strcmp(metadata_open_graph_description, "OG description text.") == 0 &&
         "equals assertion failed");
  assert(metadata_open_graph_image != NULL &&
         strcmp(metadata_open_graph_image, "https://example.com/image.jpg") ==
             0 &&
         "equals assertion failed");
  htm_free_string(content);
...
void test_og_multiple_tags(void) {
  ...
  HTMAlefHandle result = htm_convert(
      "<html><head><meta property=\"og:title\" content=\"Article Title\"><meta "
      ...
      "head><body><article><p>Article content "
      "here.</p></article></body></html>",
      0);
  assert(result != 0 && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
  HTMAlefHandle metadata_handle = htm_conversion_result_metadata(result);
  ...
  char *metadata_open_graph_title =
      alef_json_get_string(open_graph_json, "title");
  char *metadata_open_graph_type =
      alef_json_get_string(open_graph_json, "type");
  char *metadata_open_graph_url = alef_json_get_string(open_graph_json, "url");
  char *metadata_open_graph_site_name =
      alef_json_get_string(open_graph_json, "site_name");
  assert(content != NULL && strlen(content) > 0 && strcmp(content, "[]") != 0 &&
         strcmp(content, "{}") != 0 && "expected non-empty value");
  assert(metadata_open_graph_title != NULL &&
         strcmp(metadata_open_graph_title, "Article Title") == 0 &&
         "equals assertion failed");
  assert(metadata_open_graph_type != NULL &&
         strcmp(metadata_open_graph_type, "article") == 0 &&
         "equals assertion failed");
  assert(metadata_open_graph_url != NULL &&
         strcmp(metadata_open_graph_url, "https://example.com/article") == 0 &&
         "equals assertion failed");
  assert(metadata_open_graph_site_name != NULL &&
         strcmp(metadata_open_graph_site_name, "Example Site") == 0 &&
         "equals assertion failed");
  htm_free_string(content);
  free(metadata_open_graph_title);
...
void test_structured_data_json_ld(void) {
  /* JSON-LD script tag is stripped from output (security) but metadata may be
   * extracted */
  HTMAlefHandle result = htm_convert(
      "<html><head><title>Article</title><script "
...
void test_structured_data_multiple_json_ld(void) {
  ...
  HTMAlefHandle result =
      htm_convert("<html><head><title>Shop Page</title><script "
                  "type=\"application/ld+json\">{\"@context\":\"https://"
                  "schema.org\",\"@type\":\"Product\",\"name\":\"Widget\","
                  "\"price\":\"9.99\"}</script><script "
                  "type=\"application/ld+json\">{\"@context\":\"https://"
                  "schema.org\",\"@type\":\"BreadcrumbList\","
                  "\"itemListElement\":[{\"@type\":\"ListItem\",\"position\":1,"
                  "\"name\":\"Home\"}]}</script></head><body><h1>Widget</"
                  "h1><p>A great widget for all purposes.</p></body></html>",
                  0);
  assert(result != 0 && "expected call to succeed");
  char *content = htm_conversion_result_content(result);
  assert(content != NULL && strlen(content) > 0 && strcmp(content, "[]") != 0 &&
         strcmp(content, "{}") != 0 && "expected non-empty value");
  assert(content != NULL && strstr(content, "Widget") != NULL &&
         "expected to contain substring");
  htm_free_string(content);
  htm_conversion_result_free(result);
}
...
void test_twitter_card_tags(void) {
  ...
  HTMAlefHandle result = htm_convert(
      "<html><head><meta name=\"twitter:card\" "
      "content=\"summary_large_image\"><meta name=\"twitter:site\" "
      "content=\"@examplesite\"><meta name=\"twitter:title\" content=\"Twitter "
      "Card Title\"><meta name=\"twitter:description\" content=\"Twitter card "
  ...
  char *metadata_twitter_title =
      alef_json_get_string(twitter_card_json, "title");
  char *metadata_twitter_description =
      alef_json_get_string(twitter_card_json, "description");
  assert(content != NULL && strlen(content) > 0 && strcmp(content, "[]") != 0 &&
         strcmp(content, "{}") != 0 && "expected non-empty value");
  assert(metadata_twitter_card != NULL &&
         strcmp(metadata_twitter_card, "summary_large_image") == 0 &&
         "equals assertion failed");
  assert(metadata_twitter_title != NULL &&
         strcmp(metadata_twitter_title, "Twitter Card Title") == 0 &&
         "equals assertion failed");
  assert(metadata_twitter_description != NULL &&
         strcmp(metadata_twitter_description, "Twitter card description.") ==
             0 &&
         "equals assertion failed");
  htm_free_string(content);
