...
// alef:hash:71e9e1d7a9a20a756848b45003c7212c173cad7429260f95e5ba4a44b28c3fbf
...
void test_metadata_author_meta(void) {
    ...
    HTMConvert* result = htm_convert("<html><head><title>Page</title><meta name=\"author\" content=\"Jane Doe\"></head><body><p>Content</p></body></html>", NULL);
...
void test_metadata_canonical_url(void) {
    ...
    HTMConvert* result = htm_convert("<html><head><title>Page</title><link rel=\"canonical\" href=\"https://example.com/canonical-page\"></head><body><p>Content</p></body></html>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_convert_content(result);
    HTMMetadata* metadata_handle = htm_convert_metadata(result);
    assert(metadata_handle != NULL);
...
void test_metadata_description_meta(void) {
    ...
    HTMConvert* result = htm_convert("<html><head><title>Page</title><meta name=\"description\" content=\"This is the page description.\"></head><body><p>Content</p></body></html>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_convert_content(result);
    HTMMetadata* metadata_handle = htm_convert_metadata(result);
    assert(metadata_handle != NULL);
...
void test_metadata_extract_all_images(void) {
    ...
    HTMConvert* result = htm_convert("<html><head><title>Gallery</title></head><body><img src=\"https://example.com/photo1.jpg\" alt=\"Photo 1\"><img src=\"https://example.com/photo2.png\" alt=\"Photo 2\"><img src=\"/local/image.webp\" alt=\"Local image\"></body></html>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_convert_content(result);
    HTMMetadata* metadata_handle = htm_convert_metadata(result);
    assert(metadata_handle != NULL);
...
void test_metadata_extract_all_links(void) {
    ...
    HTMConvert* result = htm_convert("<html><head><title>Links Page</title></head><body><p>Visit <a href=\"https://example.com\">Example</a> or <a href=\"https://docs.example.com\">Docs</a>.</p><p>Also see <a href=\"/relative/path\">relative link</a> and <a href=\"mailto:hello@example.com\">email us</a>.</p></body></html>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_convert_content(result);
    HTMMetadata* metadata_handle = htm_convert_metadata(result);
    assert(metadata_handle != NULL);
...
void test_metadata_headers_hierarchy(void) {
    ...
    HTMConvert* result = htm_convert("<html><head><title>Docs</title></head><body><h1>Introduction</h1><h2>Getting Started</h2><h3>Installation</h3><h3>Configuration</h3><h2>Advanced Usage</h2><h3>Custom Options</h3></body></html>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_convert_content(result);
    HTMMetadata* metadata_handle = htm_convert_metadata(result);
    assert(metadata_handle != NULL);
...
void test_metadata_keywords_meta(void) {
    ...
    HTMConvert* result = htm_convert("<html><head><title>Page</title><meta name=\"keywords\" content=\"rust, markdown, html, converter\"></head><body><p>Content</p></body></html>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_convert_content(result);
    HTMMetadata* metadata_handle = htm_convert_metadata(result);
    assert(metadata_handle != NULL);
...
void test_metadata_lang_attribute(void) {
    ...
    HTMConvert* result = htm_convert("<html lang=\"es\"><head><title>Spanish Page</title></head><body><h1>Hola Mundo</h1><p>Este es un documento en español.</p></body></html>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_convert_content(result);
    assert(strlen(content) > 0 && "expected non-empty value");
...
void test_metadata_microdata_schema_article(void) {
    ...
    HTMConvert* result = htm_convert("<html><head><title>Article</title></head><body><article itemscope itemtype=\"https://schema.org/Article\"><h1 itemprop=\"headline\">Breaking News Today</h1><span itemprop=\"author\">Jane Reporter</span><span itemprop=\"datePublished\">2024-04-22</span><div itemprop=\"articleBody\"><p>The article content goes here with important information about the breaking news story.</p></div></article></body></html>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_convert_content(result);
    assert(strlen(content) > 0 && "expected non-empty value");
...
void test_metadata_microdata_schema_organization(void) {
    ...
    HTMConvert* result = htm_convert("<html><head><title>Company</title></head><body><div itemscope itemtype=\"https://schema.org/Organization\"><span itemprop=\"name\">Acme Corp</span><span itemprop=\"foundingDate\">2020</span><span itemprop=\"url\">https://acmecorp.example.com</span><span itemprop=\"logo\">https://acmecorp.example.com/logo.png</span></div></body></html>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_convert_content(result);
    assert(strlen(content) > 0 && "expected non-empty value");
...
void test_metadata_microdata_schema_person(void) {
    ...
    HTMConvert* result = htm_convert("<html><head><title>Contact</title></head><body><div itemscope itemtype=\"https://schema.org/Person\"><span itemprop=\"name\">John Smith</span><span itemprop=\"email\">john@example.com</span><span itemprop=\"telephone\">+1-555-0100</span></div></body></html>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_convert_content(result);
    assert(strlen(content) > 0 && "expected non-empty value");
...
void test_metadata_text_direction_ltr(void) {
    ...
    HTMConvert* result = htm_convert("<html lang=\"en\" dir=\"ltr\"><head><title>LTR Document</title></head><body><p>This is left-to-right text.</p></body></html>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_convert_content(result);
    assert(strlen(content) > 0 && "expected non-empty value");
...
void test_metadata_text_direction_rtl(void) {
    ...
    HTMConvert* result = htm_convert("<html lang=\"ar\" dir=\"rtl\"><head><title>RTL Document</title></head><body><p>This is right-to-left text.</p></body></html>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_convert_content(result);
    assert(strlen(content) > 0 && "expected non-empty value");
...
void test_metadata_title_tag(void) {
    ...
    HTMConvert* result = htm_convert("<html><head><title>My Page</title></head><body><p>Content</p></body></html>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_convert_content(result);
    HTMMetadata* metadata_handle = htm_convert_metadata(result);
    assert(metadata_handle != NULL);
...
void test_og_basic_tags(void) {
    ...
    HTMConvert* result = htm_convert("<html><head><title>Fallback Title</title><meta property=\"og:title\" content=\"OG Title\"><meta property=\"og:description\" content=\"OG description text.\"><meta property=\"og:image\" content=\"https://example.com/image.jpg\"></head><body><p>Content</p></body></html>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_convert_content(result);
    HTMMetadata* metadata_handle = htm_convert_metadata(result);
    assert(metadata_handle != NULL);
...
void test_structured_data_json_ld(void) {
    ...
    HTMConvert* result = htm_convert("<html><head><title>Article</title><script type=\"application/ld+json\">{\"@context\":\"https://schema.org\",\"@type\":\"Article\",\"headline\":\"My Article\",\"author\":{\"@type\":\"Person\",\"name\":\"Jane Doe\"},\"datePublished\":\"2024-01-15\"}</script></head><body><h1>My Article</h1><p>Article body text.</p></body></html>", NULL);
    assert(result != NULL && "expected call to succeed");
    char* content = htm_convert_content(result);
    assert(strlen(content) > 0 && "expected non-empty value");
