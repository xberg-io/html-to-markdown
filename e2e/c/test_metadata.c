 ...
 * alef:hash:fe330730c18f5449258e2ed849710934d6d779cf93c2610a2d7b8b126ee110d9
...
void test_metadata_author_meta(void) {
    ...
    char *metadata_author = htm_document_structure_author(document_handle);
...
void test_metadata_canonical_url(void) {
    ...
    HTMDocumentStructure *document_handle = htm_conversion_result_document(result);
    assert(document_handle != NULL);
    char *metadata_canonical_url = htm_document_structure_canonical_url(document_handle);
    assert(content != NULL && strlen(content) > 0 && "expected non-empty value");
...
void test_metadata_extract_all_images(void) {
    ...
    assert(result != NULL && "expected call to succeed");
    char *content = htm_conversion_result_content(result);
    char *metadata_images = htm_conversion_result_images(result);
    assert(content != NULL && strlen(content) > 0 && "expected non-empty value");
    {
...
void test_metadata_extract_all_links(void) {
    ...
    assert(result != NULL && "expected call to succeed");
    char *content = htm_conversion_result_content(result);
    char *metadata_links = htm_conversion_result_links(result);
    assert(content != NULL && strlen(content) > 0 && "expected non-empty value");
    {
        /* count_min: count top-level JSON array elements */
...
void test_metadata_headers_hierarchy(void) {
    ...
    assert(result != NULL && "expected call to succeed");
    char *content = htm_conversion_result_content(result);
    char *metadata_headings = htm_conversion_result_headers(result);
    assert(content != NULL && strlen(content) > 0 && "expected non-empty value");
    {
        /* count_min: count top-level JSON array elements */
...
void test_metadata_keywords_meta(void) {
    ...
    HTMDocumentStructure *document_handle = htm_conversion_result_document(result);
    assert(document_handle != NULL);
    char *metadata_document_keywords = htm_document_structure_keywords(document_handle);
    assert(content != NULL && strlen(content) > 0 && "expected non-empty value");
    {
        /* count_min: count top-level JSON array elements */
...
void test_og_basic_tags(void) {
    ...
    HTMDocumentStructure *document_handle = htm_conversion_result_document(result);
    assert(document_handle != NULL);
    char *open_graph_json = htm_document_structure_open_graph(document_handle);
...
void test_twitter_card_tags(void) {
    ...
    HTMDocumentStructure *document_handle = htm_conversion_result_document(result);
    assert(document_handle != NULL);
    char *twitter_card_json = htm_document_structure_twitter_card(document_handle);
