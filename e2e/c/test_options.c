 ...
 * alef:hash:a3a33a9d9d1119c46fae3e69dff213a29dd8874450f161eccc4e8abfa27e7e4f
...
void test_options_extract_metadata_true(void) {
    ...
    char *metadata_title = htm_document_structure_title(document_handle);
    char *metadata_description = htm_document_structure_description(document_handle);
    assert(content != NULL && strlen(content) > 0 && "expected non-empty value");
