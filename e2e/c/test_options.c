...
// alef:hash:c9d4dbeb589aefb007895f042d2ec86e051c9242551807b87431599b2638e7fd
...
void test_options_code_block_backticks(void) {
    ...
    HTMHtmConvert *result = htm_convert(
...
void test_options_exclude_selectors_nested_content_dropped(void) {
    ...
    HTMHtmConvert *result = htm_convert("<body><aside class=\"sidebar\"><h2>Related</h2><p>Sidebar "
...
void test_options_link_style_reference(void) {
    ...
    HTMHtmConvert *result = htm_convert("<p><a href='https://example.com'>Example</a> and <a "
...
void test_options_preprocessing_aggressive(void) {
    ...
    HTMHtmConvert *result = htm_convert("<nav>Menu</nav><article><h1>Title</h1><p>Content</p></"
...
void test_options_strip_tags_div_span(void) {
    ...
    HTMHtmConvert *result = htm_convert("<div class='wrapper'><p>Inside div</p></div><p>Outside "
...
void test_options_wrap_disabled(void) {
    ...
    HTMHtmConvert *result = htm_convert("<p>This is a long paragraph that should not be wrapped at "
