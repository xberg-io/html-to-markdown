...
// alef:hash:bd311cdcd0cf2a9a5262c0c23106a34e9e0d4718ea41f3328f9b9f3a0d7c1cea
...
void test_options_exclude_selectors_nested_content_dropped(void) {
    ...
    HTMConvert *result = htm_convert("<body><aside class=\"sidebar\"><h2>Related</h2><p>Sidebar "
...
void test_options_link_style_reference(void) {
    ...
    HTMConvert *result = htm_convert("<p><a href='https://example.com'>Example</a> and <a "
...
void test_options_preprocessing_aggressive(void) {
    ...
    HTMConvert *result = htm_convert("<nav>Menu</nav><article><h1>Title</h1><p>Content</p></"
...
void test_options_strip_tags_div_span(void) {
    ...
    HTMConvert *result = htm_convert("<div class='wrapper'><p>Inside div</p></div><p>Outside <span "
                                     "class='hl'>span text</span></p>",
                                     options_handle);
    assert(result != NULL && "expected call to succeed");
    char *content = htm_convert_content(result);
...
void test_options_wrap_disabled(void) {
    ...
    HTMConvert *result = htm_convert("<p>This is a long paragraph that should not be wrapped at "
...
void test_options_wrap_enabled(void) {
    ...
    HTMConvert *result = htm_convert("<p>This is a long paragraph that should be wrapped at the "
