 ...
 * alef:hash:da9b13e6d348fc0de8e0060611398b3ec7025ceac7619f9de5f26526577b5b27
...
int main(void) {
  ...
  /* Category: conversion */
  printf("  Running test_adjacent_code_spans_merged...");
  alef_current_test_status = ALEF_TEST_PASSED;
  test_adjacent_code_spans_merged();
  ...
  printf("  Running test_adjacent_inserted_merged...");
  alef_current_test_status = ALEF_TEST_PASSED;
  test_adjacent_inserted_merged();
  if (alef_current_test_status == ALEF_TEST_FAILED) {
    printf(" FAILED\n");
    failed++;
  } else if (alef_current_test_status == ALEF_TEST_SKIPPED) {
  ...
  printf("  Running test_adjacent_strikethrough_merged...");
  alef_current_test_status = ALEF_TEST_PASSED;
  test_adjacent_strikethrough_merged();
  if (alef_current_test_status == ALEF_TEST_FAILED) {
    printf(" FAILED\n");
    failed++;
  } else if (alef_current_test_status == ALEF_TEST_SKIPPED) {
  ...
  printf("  Running test_adjacent_variable_merged...");
  alef_current_test_status = ALEF_TEST_PASSED;
  test_adjacent_variable_merged();
  if (alef_current_test_status == ALEF_TEST_FAILED) {
    printf(" FAILED\n");
    failed++;
  } else if (alef_current_test_status == ALEF_TEST_SKIPPED) {
  ...
  printf("  Running test_br_only_bold_wrapper_keeps_separator...");
  alef_current_test_status = ALEF_TEST_PASSED;
  test_br_only_bold_wrapper_keeps_separator();
  if (alef_current_test_status == ALEF_TEST_FAILED) {
    printf(" FAILED\n");
    failed++;
  } else if (alef_current_test_status == ALEF_TEST_SKIPPED) {
  ...
  printf(
      "  Running test_br_only_emphasis_inside_empty_strong_keeps_separator...");
  alef_current_test_status = ALEF_TEST_PASSED;
  test_br_only_emphasis_inside_empty_strong_keeps_separator();
  if (alef_current_test_status == ALEF_TEST_FAILED) {
    printf(" FAILED\n");
    failed++;
  } else if (alef_current_test_status == ALEF_TEST_SKIPPED) {
  ...
  printf("  Running test_code_block_br_keeps_real_newline...");
  alef_current_test_status = ALEF_TEST_PASSED;
  test_code_block_br_keeps_real_newline();
  if (alef_current_test_status == ALEF_TEST_FAILED) {
    printf(" FAILED\n");
    failed++;
  } else if (alef_current_test_status == ALEF_TEST_SKIPPED) {
  ...
  printf("  Running test_code_span_br_splits_into_hard_break...");
  alef_current_test_status = ALEF_TEST_PASSED;
  test_code_span_br_splits_into_hard_break();
  if (alef_current_test_status == ALEF_TEST_FAILED) {
    printf(" FAILED\n");
    failed++;
  } else if (alef_current_test_status == ALEF_TEST_SKIPPED) {
  ...
  printf("  Running test_code_span_literal_newline_folds_to_space...");
  alef_current_test_status = ALEF_TEST_PASSED;
  test_code_span_literal_newline_folds_to_space();
  if (alef_current_test_status == ALEF_TEST_FAILED) {
    printf(" FAILED\n");
    failed++;
  } else if (alef_current_test_status == ALEF_TEST_SKIPPED) {
  ...
  printf("  Running test_code_span_suppresses_nested_inline_markers...");
  alef_current_test_status = ALEF_TEST_PASSED;
  test_code_span_suppresses_nested_inline_markers();
  if (alef_current_test_status == ALEF_TEST_FAILED) {
    printf(" FAILED\n");
    failed++;
  } else if (alef_current_test_status == ALEF_TEST_SKIPPED) {
  ...
  printf("  Running test_div_whitespace_only_span_does_not_indent_image...");
  alef_current_test_status = ALEF_TEST_PASSED;
  test_div_whitespace_only_span_does_not_indent_image();
  if (alef_current_test_status == ALEF_TEST_FAILED) {
    printf(" FAILED\n");
    failed++;
  } else if (alef_current_test_status == ALEF_TEST_SKIPPED) {
  ...
  printf("  Running test_heading_br_only_nested_emphasis_keeps_separator...");
  alef_current_test_status = ALEF_TEST_PASSED;
  test_heading_br_only_nested_emphasis_keeps_separator();
  if (alef_current_test_status == ALEF_TEST_FAILED) {
    printf(" FAILED\n");
    failed++;
  } else if (alef_current_test_status == ALEF_TEST_SKIPPED) {
  ...
  printf("  Running test_image_alt_unmatched_open_bracket_is_escaped...");
  alef_current_test_status = ALEF_TEST_PASSED;
  test_image_alt_unmatched_open_bracket_is_escaped();
  if (alef_current_test_status == ALEF_TEST_FAILED) {
    printf(" FAILED\n");
    failed++;
  } else if (alef_current_test_status == ALEF_TEST_SKIPPED) {
  ...
  printf("  Running test_image_kept_inline_in_link...");
  alef_current_test_status = ALEF_TEST_PASSED;
  test_image_kept_inline_in_link();
  if (alef_current_test_status == ALEF_TEST_FAILED) {
    printf(" FAILED\n");
    failed++;
  } else if (alef_current_test_status == ALEF_TEST_SKIPPED) {
  ...
  printf("  Running test_image_multiline_alt_block_marker_is_escaped...");
  alef_current_test_status = ALEF_TEST_PASSED;
  test_image_multiline_alt_block_marker_is_escaped();
  if (alef_current_test_status == ALEF_TEST_FAILED) {
    printf(" FAILED\n");
    failed++;
  } else if (alef_current_test_status == ALEF_TEST_SKIPPED) {
  ...
  printf("  Running test_image_src_entity_shaped_ampersand_kept_literal...");
  alef_current_test_status = ALEF_TEST_PASSED;
  test_image_src_entity_shaped_ampersand_kept_literal();
  if (alef_current_test_status == ALEF_TEST_FAILED) {
    printf(" FAILED\n");
    failed++;
  } else if (alef_current_test_status == ALEF_TEST_SKIPPED) {
  ...
  printf("  Running test_link_href_entity_shaped_ampersand_kept_literal...");
  alef_current_test_status = ALEF_TEST_PASSED;
  test_link_href_entity_shaped_ampersand_kept_literal();
  if (alef_current_test_status == ALEF_TEST_FAILED) {
    printf(" FAILED\n");
    failed++;
  } else if (alef_current_test_status == ALEF_TEST_SKIPPED) {
  ...
  printf("  Running test_link_label_block_marker_is_escaped...");
  alef_current_test_status = ALEF_TEST_PASSED;
  test_link_label_block_marker_is_escaped();
  if (alef_current_test_status == ALEF_TEST_FAILED) {
    printf(" FAILED\n");
    failed++;
  } else if (alef_current_test_status == ALEF_TEST_SKIPPED) {
  ...
  printf("  Running test_link_label_unmatched_open_bracket_is_escaped...");
  alef_current_test_status = ALEF_TEST_PASSED;
  test_link_label_unmatched_open_bracket_is_escaped();
  if (alef_current_test_status == ALEF_TEST_FAILED) {
    printf(" FAILED\n");
    failed++;
  } else if (alef_current_test_status == ALEF_TEST_SKIPPED) {
  ...
  printf("  Running test_link_leading_line_break_is_kept...");
  alef_current_test_status = ALEF_TEST_PASSED;
  test_link_leading_line_break_is_kept();
  if (alef_current_test_status == ALEF_TEST_FAILED) {
    printf(" FAILED\n");
    failed++;
  } else if (alef_current_test_status == ALEF_TEST_SKIPPED) {
  ...
  printf("  Running test_link_split_by_block_child_is_not_duplicated...");
  alef_current_test_status = ALEF_TEST_PASSED;
  test_link_split_by_block_child_is_not_duplicated();
  if (alef_current_test_status == ALEF_TEST_FAILED) {
    printf(" FAILED\n");
    failed++;
  } else if (alef_current_test_status == ALEF_TEST_SKIPPED) {
  ...
  printf("  Running test_link_split_drops_empty_authored_half...");
  alef_current_test_status = ALEF_TEST_PASSED;
  test_link_split_drops_empty_authored_half();
  if (alef_current_test_status == ALEF_TEST_FAILED) {
    printf(" FAILED\n");
    failed++;
  } else if (alef_current_test_status == ALEF_TEST_SKIPPED) {
  ...
  printf("  Running test_link_split_keeps_text_bearing_half...");
  alef_current_test_status = ALEF_TEST_PASSED;
  test_link_split_keeps_text_bearing_half();
  if (alef_current_test_status == ALEF_TEST_FAILED) {
    printf(" FAILED\n");
    failed++;
  } else if (alef_current_test_status == ALEF_TEST_SKIPPED) {
  ...
  printf("  Running test_link_trailing_line_break_is_kept...");
  alef_current_test_status = ALEF_TEST_PASSED;
  test_link_trailing_line_break_is_kept();
  if (alef_current_test_status == ALEF_TEST_FAILED) {
    printf(" FAILED\n");
    failed++;
  } else if (alef_current_test_status == ALEF_TEST_SKIPPED) {
  ...
  printf("  Running test_link_wrapping_table_renders_table...");
  alef_current_test_status = ALEF_TEST_PASSED;
  test_link_wrapping_table_renders_table();
  if (alef_current_test_status == ALEF_TEST_FAILED) {
    printf(" FAILED\n");
    failed++;
  } else if (alef_current_test_status == ALEF_TEST_SKIPPED) {
  ...
  printf("  Running "
         "test_nested_newline_only_spans_after_emphasis_keep_separator...");
  alef_current_test_status = ALEF_TEST_PASSED;
  test_nested_newline_only_spans_after_emphasis_keep_separator();
  if (alef_current_test_status == ALEF_TEST_FAILED) {
    printf(" FAILED\n");
  ...
  printf("  Running test_nested_newline_only_spans_keep_separator...");
  alef_current_test_status = ALEF_TEST_PASSED;
  test_nested_newline_only_spans_keep_separator();
  if (alef_current_test_status == ALEF_TEST_FAILED) {
    printf(" FAILED\n");
    failed++;
  } else if (alef_current_test_status == ALEF_TEST_SKIPPED) {
  ...
  printf("  Running test_paragraph_whitespace_only_span_separates_words...");
  alef_current_test_status = ALEF_TEST_PASSED;
  test_paragraph_whitespace_only_span_separates_words();
  if (alef_current_test_status == ALEF_TEST_FAILED) {
    printf(" FAILED\n");
    failed++;
  } else if (alef_current_test_status == ALEF_TEST_SKIPPED) {
  ...
  printf("  Running "
         "test_space_only_italic_inside_empty_strong_keeps_separator...");
  alef_current_test_status = ALEF_TEST_PASSED;
  test_space_only_italic_inside_empty_strong_keeps_separator();
  if (alef_current_test_status == ALEF_TEST_FAILED) {
    printf(" FAILED\n");
  ...
  printf("  Running test_strike_renders_as_strikethrough...");
  alef_current_test_status = ALEF_TEST_PASSED;
  test_strike_renders_as_strikethrough();
  if (alef_current_test_status == ALEF_TEST_FAILED) {
    printf(" FAILED\n");
    failed++;
  } else if (alef_current_test_status == ALEF_TEST_SKIPPED) {
  ...
  printf("  Running test_table_cell_br_only_emphasis_keeps_separator...");
  alef_current_test_status = ALEF_TEST_PASSED;
  test_table_cell_br_only_emphasis_keeps_separator();
  if (alef_current_test_status == ALEF_TEST_FAILED) {
    printf(" FAILED\n");
    failed++;
  } else if (alef_current_test_status == ALEF_TEST_SKIPPED) {
  ...
  printf("  Running test_table_content_after_unclosed_row_survives...");
  alef_current_test_status = ALEF_TEST_PASSED;
  test_table_content_after_unclosed_row_survives();
  if (alef_current_test_status == ALEF_TEST_FAILED) {
    printf(" FAILED\n");
    failed++;
  } else if (alef_current_test_status == ALEF_TEST_SKIPPED) {
  ...
  printf("  Running test_table_layout_row_keeps_image...");
  alef_current_test_status = ALEF_TEST_PASSED;
  test_table_layout_row_keeps_image();
  if (alef_current_test_status == ALEF_TEST_FAILED) {
    printf(" FAILED\n");
    failed++;
  } else if (alef_current_test_status == ALEF_TEST_SKIPPED) {
  ...
  printf("  Running test_table_nested_in_single_cell_renders_separately...");
  alef_current_test_status = ALEF_TEST_PASSED;
  test_table_nested_in_single_cell_renders_separately();
  if (alef_current_test_status == ALEF_TEST_FAILED) {
    printf(" FAILED\n");
    failed++;
  } else if (alef_current_test_status == ALEF_TEST_SKIPPED) {
  ...
  printf("  Running test_table_nested_in_wrapper_renders_separately...");
  alef_current_test_status = ALEF_TEST_PASSED;
  test_table_nested_in_wrapper_renders_separately();
  if (alef_current_test_status == ALEF_TEST_FAILED) {
    printf(" FAILED\n");
    failed++;
  } else if (alef_current_test_status == ALEF_TEST_SKIPPED) {
  ...
  printf("  Running test_table_ragged_rows_padded_not_listed...");
  alef_current_test_status = ALEF_TEST_PASSED;
  test_table_ragged_rows_padded_not_listed();
  if (alef_current_test_status == ALEF_TEST_FAILED) {
    printf(" FAILED\n");
    failed++;
  } else if (alef_current_test_status == ALEF_TEST_SKIPPED) {
  ...
  printf("  Running test_tagged_space_in_strikethrough_kept...");
  alef_current_test_status = ALEF_TEST_PASSED;
  test_tagged_space_in_strikethrough_kept();
  if (alef_current_test_status == ALEF_TEST_FAILED) {
    printf(" FAILED\n");
    failed++;
  } else if (alef_current_test_status == ALEF_TEST_SKIPPED) {
  ...
  printf("  Running test_tagged_space_in_subscript_kept...");
  alef_current_test_status = ALEF_TEST_PASSED;
  test_tagged_space_in_subscript_kept();
  if (alef_current_test_status == ALEF_TEST_FAILED) {
    printf(" FAILED\n");
    failed++;
  } else if (alef_current_test_status == ALEF_TEST_SKIPPED) {
  ...
  printf("  Running test_whitespace_only_bold_wrapper_keeps_separator...");
  alef_current_test_status = ALEF_TEST_PASSED;
  test_whitespace_only_bold_wrapper_keeps_separator();
  if (alef_current_test_status == ALEF_TEST_FAILED) {
    printf(" FAILED\n");
    failed++;
  } else if (alef_current_test_status == ALEF_TEST_SKIPPED) {
  ...
  printf("  Running test_whitespace_only_code_span_kept...");
  alef_current_test_status = ALEF_TEST_PASSED;
  test_whitespace_only_code_span_kept();
  if (alef_current_test_status == ALEF_TEST_FAILED) {
    printf(" FAILED\n");
    failed++;
  } else if (alef_current_test_status == ALEF_TEST_SKIPPED) {
  ...
  printf("  Running test_encoding_c1_replacement_table...");
  alef_current_test_status = ALEF_TEST_PASSED;
  test_encoding_c1_replacement_table();
  if (alef_current_test_status == ALEF_TEST_FAILED) {
    printf(" FAILED\n");
    failed++;
  } else if (alef_current_test_status == ALEF_TEST_SKIPPED) {
  ...
  printf("  Running test_malformed_row_nested_in_cell_keeps_text...");
  alef_current_test_status = ALEF_TEST_PASSED;
  test_malformed_row_nested_in_cell_keeps_text();
  if (alef_current_test_status == ALEF_TEST_FAILED) {
    printf(" FAILED\n");
    failed++;
  } else if (alef_current_test_status == ALEF_TEST_SKIPPED) {
  ...
  printf("  Running "
         "test_options_br_in_tables_anchor_wrapped_nested_table_in_layout_cell."
         "..");
  alef_current_test_status = ALEF_TEST_PASSED;
  test_options_br_in_tables_anchor_wrapped_nested_table_in_layout_cell();
  if (alef_current_test_status == ALEF_TEST_FAILED) {
