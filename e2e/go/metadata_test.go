...
// alef:hash:432405afa5cb16a361c43c45dd409e86ddd9b9ee76222741318b05db5a2e6191
...
func Test_MetadataAuthorMeta(t *testing.T) {
	...
	if result.Metadata.Document.Author != nil {
		metadataDocumentAuthor = fmt.Sprintf("%v", *result.Metadata.Document.Author)
	}
...
func Test_MetadataCanonicalUrl(t *testing.T) {
	...
	if result.Metadata.Document.CanonicalURL != nil {
		metadataDocumentCanonicalURL = fmt.Sprintf("%v", *result.Metadata.Document.CanonicalURL)
	}
	if result.Content == nil {
		t.Errorf("expected non-empty value")
	}
