...
// alef:hash:c143a5b93dc28248e7a0bf0abf9d08c4a21a805756fc2091d74046f379425ea3
...
func Test_OptionsAutolinksFalse(t *testing.T) {
	...
	if result.Content == nil || !strings.Contains(string(*result.Content), `example.com`) {
		t.Errorf("expected to contain %s", `example.com`)
	}
}

func Test_OptionsBrInTablesAnchorWrappedNestedTableInLayoutCell(t *testing.T) {
	// An anchor-wrapped table inside a layout cell keeps its inner links clickable
	var options htmd.ConversionOptions
	if err := json.Unmarshal([]byte(`{"br_in_tables":true,"compact_tables":true}`), &options); err != nil {
		t.Fatalf("config parse failed: %v", err)
	}
...
func Test_OptionsBrInTablesFalse(t *testing.T) {
	...
	if result.Content == nil || !strings.Contains(string(*result.Content), `Col`) {
		t.Errorf("expected to contain %s", `Col`)
	}
}

func Test_OptionsBrInTablesNestedDataTable(t *testing.T) {
...
func Test_OptionsBrInTablesNestedTableRows(t *testing.T) {
	...
	if result.Content == nil || !strings.Contains(string(*result.Content), `Before<br>`) {
		t.Errorf("expected to contain %s", `Before<br>`)
	}
	if result.Content == nil || !strings.Contains(string(*result.Content), `<br>`) {
		t.Errorf("expected to contain %s", `<br>`)
	}
	if result.Content == nil || !strings.Contains(string(*result.Content), `123`) {
		t.Errorf("expected to contain %s", `123`)
	}
	if result.Content == nil || !strings.Contains(string(*result.Content), `Done`) {
		t.Errorf("expected to contain %s", `Done`)
	}
	if result.Content == nil || !strings.Contains(string(*result.Content), `Status`) {
		t.Errorf("expected to contain %s", `Status`)
	}
}
...
func Test_OptionsBrInTablesTrue(t *testing.T) {
	...
	if result.Content == nil || !strings.Contains(string(*result.Content), `Header`) {
		t.Errorf("expected to contain %s", `Header`)
	}
	if result.Content == nil || !strings.Contains(string(*result.Content), `Line 1`) {
		t.Errorf("expected to contain %s", `Line 1`)
	}
	if result.Content == nil || !strings.Contains(string(*result.Content), `Line 2`) {
...
func Test_OptionsCodeBlockBackticks(t *testing.T) {
	...
	if result.Content == nil || !strings.Contains(string(*result.Content), `console.log('hi');`) {
...
func Test_OptionsCodeBlockTildes(t *testing.T) {
	...
	if result.Content == nil || !strings.Contains(string(*result.Content), `let x = 1;`) {
...
func Test_OptionsCodeBlockTildesStyle(t *testing.T) {
	...
	if result.Content == nil || !strings.Contains(string(*result.Content), `some code`) {
...
func Test_OptionsCodeLanguagePython(t *testing.T) {
	...
	if result.Content == nil || !strings.Contains(string(*result.Content), "```python") {
		t.Errorf("expected to contain %s", "```python")
	}
	if result.Content == nil || !strings.Contains(string(*result.Content), `def hello`) {
...
func Test_OptionsCustomBulletsApplyToLayoutTableRows(t *testing.T) {
	...
	if !strings.Contains(string(content), `* alpha`) {
		t.Errorf("expected to contain %s, got %v", `* alpha`, content)
	}
	if strings.Contains(string(content), `- alpha`) {
		t.Errorf("expected NOT to contain %s, got %v", `- alpha`, content)
	}
}
...
func Test_OptionsDebugTrue(t *testing.T) {
	...
	if result.Content == nil || !strings.Contains(string(*result.Content), `Debug test`) {
...
func Test_OptionsDefaultTitleTrue(t *testing.T) {
	...
	if result.Content == nil || !strings.Contains(string(*result.Content), `Link`) {
...
func Test_OptionsEscapeAsciiEnabled(t *testing.T) {
	...
	if result.Content == nil || !strings.Contains(string(*result.Content), `Text`) {
		t.Errorf("expected to contain %s", `Text`)
	}
	if result.Content == nil || !strings.Contains(string(*result.Content), `hash`) {
		t.Errorf("expected to contain %s", `hash`)
	}
	if result.Content == nil || !strings.Contains(string(*result.Content), `brackets`) {
		t.Errorf("expected to contain %s", `brackets`)
	}
	if result.Content == nil || !strings.Contains(string(*result.Content), `star`) {
...
func Test_OptionsEscapeAsterisks(t *testing.T) {
	...
	if result.Content == nil || !strings.Contains(string(*result.Content), `3`) {
		t.Errorf("expected to contain %s", `3`)
	}
	if result.Content == nil || !strings.Contains(string(*result.Content), `6`) {
...
func Test_OptionsEscapeMisc(t *testing.T) {
	...
	if result.Content == nil || !strings.Contains(string(*result.Content), `Use`) {
		t.Errorf("expected to contain %s", `Use`)
	}
	if result.Content == nil || !strings.Contains(string(*result.Content), `and`) {
		t.Errorf("expected to contain %s", `and`)
	}
	if result.Content == nil || !strings.Contains(string(*result.Content), `in text.`) {
...
func Test_OptionsEscapeUnderscores(t *testing.T) {
	...
	if result.Content == nil || !strings.Contains(string(*result.Content), `variable`) {
	...
	if result.Content == nil || !strings.Contains(string(*result.Content), `defined.`) {
...
func Test_OptionsExtractImagesTrueDataUri(t *testing.T) {
	...
	if result.Content == nil || !strings.Contains(string(*result.Content), `After`) {
...
func Test_OptionsExtractMetadataTrue(t *testing.T) {
	...
	if string(metadataDocumentTitle) != `Test Page` {
		t.Errorf("equals mismatch: got %v", metadataDocumentTitle)
	}
	if string(metadataDocumentDescription) != `A test page` {
...
func Test_OptionsHeadingStyleAtx(t *testing.T) {
	...
	if result.Content == nil || !strings.Contains(string(*result.Content), `## Subtitle`) {
...
func Test_OptionsHeadingStyleAtxClosed(t *testing.T) {
	...
	if result.Content == nil || !strings.Contains(string(*result.Content), `# Closed Heading #`) {
...
func Test_OptionsHeadingStyleUnderlined(t *testing.T) {
	...
	if result.Content == nil || !strings.Contains(string(*result.Content), `Main Title`) {
...
func Test_OptionsKeepInlineImagesInParagraph(t *testing.T) {
	...
	if result.Content == nil || !strings.Contains(string(*result.Content), `more text`) {
...
func Test_OptionsLinkStyleReference(t *testing.T) {
	...
	if result.Content == nil || !strings.Contains(string(*result.Content), `Example`) {
		t.Errorf("expected to contain %s", `Example`)
	}
	if result.Content == nil || !strings.Contains(string(*result.Content), `Other`) {
...
func Test_OptionsListIndentTabs(t *testing.T) {
	...
	if result.Content == nil || !strings.Contains(string(*result.Content), `Parent`) {
		t.Errorf("expected to contain %s", `Parent`)
	}
	if result.Content == nil || !strings.Contains(string(*result.Content), `Child`) {
...
func Test_OptionsListIndentWidthFour(t *testing.T) {
	...
	if result.Content == nil || !strings.Contains(string(*result.Content), `Outer`) {
		t.Errorf("expected to contain %s", `Outer`)
	}
	if result.Content == nil || !strings.Contains(string(*result.Content), `Inner`) {
...
func Test_OptionsNewlineSpaces(t *testing.T) {
	...
	if result.Content == nil || !strings.Contains(string(*result.Content), `First`) {
		t.Errorf("expected to contain %s", `First`)
	}
	if result.Content == nil || !strings.Contains(string(*result.Content), `Second`) {
...
func Test_OptionsOutputFormatDjot(t *testing.T) {
	...
	if result.Content == nil || !strings.Contains(string(*result.Content), `Simple paragraph.`) {
...
func Test_OptionsOutputFormatMarkdown(t *testing.T) {
	...
	if result.Content == nil || !strings.Contains(string(*result.Content), `Some text.`) {
...
func Test_OptionsOutputFormatPlain(t *testing.T) {
	...
	if result.Content != nil && strings.Contains(string(*result.Content), `**bold**`) {
		t.Errorf("expected NOT to contain %s, got %v", `**bold**`, result.Content)
	}
	if result.Content != nil && strings.Contains(string(*result.Content), `# Title`) {
		t.Errorf("expected NOT to contain %s, got %v", `# Title`, result.Content)
	}
}
...
func Test_OptionsPreprocessingEnabledFalseSkipsCleanup(t *testing.T) {
	...
	if result.Content == nil || !strings.Contains(string(*result.Content), `NavSection`) {
		t.Errorf("expected to contain %s", `NavSection`)
	}
	if result.Content == nil || !strings.Contains(string(*result.Content), `Paragraph`) {
...
func Test_OptionsPreprocessingMinimal(t *testing.T) {
	...
	if result.Content == nil || !strings.Contains(string(*result.Content), `Navigation`) {
		t.Errorf("expected to contain %s", `Navigation`)
	}
	if result.Content == nil || !strings.Contains(string(*result.Content), `Content`) {
		t.Errorf("expected to contain %s", `Content`)
	}
	if result.Content == nil || !strings.Contains(string(*result.Content), `Footer`) {
...
func Test_OptionsPreprocessingRemoveNavigationFalseKeepsNav(t *testing.T) {
	...
	if result.Content == nil || !strings.Contains(string(*result.Content), `SiteMenu`) {
		t.Errorf("expected to contain %s", `SiteMenu`)
	}
	if result.Content == nil || !strings.Contains(string(*result.Content), `MainContent`) {
		t.Errorf("expected to contain %s", `MainContent`)
	}
	if result.Content == nil || !strings.Contains(string(*result.Content), `SidebarText`) {
...
func Test_OptionsPreserveTagsIframe(t *testing.T) {
	...
	if result.Content == nil || !strings.Contains(string(*result.Content), `<iframe`) {
...
func Test_OptionsStripTagsDivSpan(t *testing.T) {
	...
	if result.Content == nil || !strings.Contains(string(*result.Content), `Inside div`) {
		t.Errorf("expected to contain %s", `Inside div`)
	}
	if result.Content == nil || !strings.Contains(string(*result.Content), `span text`) {
...
func Test_OptionsStrongEmUnderscore(t *testing.T) {
	...
	if result.Content == nil || !strings.Contains(string(*result.Content), `__bold__`) {
		t.Errorf("expected to contain %s", `__bold__`)
	}
	if result.Content == nil || !strings.Contains(string(*result.Content), `_italic_`) {
...
func Test_OptionsWhitespaceNormalized(t *testing.T) {
	...
	if result.Content == nil || !strings.Contains(string(*result.Content), `with`) {
		t.Errorf("expected to contain %s", `with`)
	}
	if result.Content == nil || !strings.Contains(string(*result.Content), `extra`) {
		t.Errorf("expected to contain %s", `extra`)
	}
	if result.Content == nil || !strings.Contains(string(*result.Content), `spaces.`) {
...
func Test_OptionsWhitespaceStrict(t *testing.T) {
	...
	if result.Content == nil || !strings.Contains(string(*result.Content), `Preserved`) {
		t.Errorf("expected to contain %s", `Preserved`)
	}
	if result.Content == nil || !strings.Contains(string(*result.Content), `spacing.`) {
...
func Test_OptionsWrapDisabled(t *testing.T) {
	...
	if result.Content == nil || !strings.Contains(string(*result.Content), `This is a long paragraph that should not be wrapped at all because wrapping is disabled.`) {
...
func Test_OptionsWrapEnabled(t *testing.T) {
	...
	if result.Content == nil || !strings.Contains(string(*result.Content), `This is a long paragraph`) {
