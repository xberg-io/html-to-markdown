...
// alef:hash:78b76bd5dfd98248ddc1172fe43778c9cc82e5f96fc520d462a7f787bffb706d
...
func Test_OptionsCustomBulletsApplyToLayoutTableRows(t *testing.T) {
	...
	result, err := htmd.Convert(`<table><tr><td>alpha</td><td>beta</td></tr><tr><td>a</td><td>b</td><td>c</td></tr></table>`, &options)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
	var content string
