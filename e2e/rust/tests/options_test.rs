...
// alef:hash:2c68488d3f54201ce2e67f397c9e8ac4051d5299ed18d81eb54f171b6260d762
...
fn test_options_extract_metadata_true() {
    ...
    assert!(result.content.is_some(), "expected content to be present");
    assert_eq!(
        format!("{:?}", metadata_document_title).as_str().trim(),
        r#"Test Page"#,
        "equals assertion failed"
    );
    assert_eq!(
        format!("{:?}", metadata_document_description).as_str().trim(),
        r#"A test page"#,
        "equals assertion failed"
    );
}
