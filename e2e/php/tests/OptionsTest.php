...
// alef:hash:23a3df0f1da9f3b72950fbbfc7240f91d7242270e50159892cec2f0a32a5d959
...
final class OptionsTest extends TestCase
{
    ...
    public function test_options_br_in_tables_anchor_wrapped_nested_table_in_layout_cell(): void
    {
    ...
    public function test_options_br_in_tables_nested_data_table(): void
    {
        $options = \HtmlToMarkdown\ConversionOptions::from_json(json_encode([
            'brInTables' => true,
            'compactTables' => true,
    ...
    public function test_options_br_in_tables_nested_table_rows(): void
    {
        $options = \HtmlToMarkdown\ConversionOptions::from_json(json_encode([
            'brInTables' => true,
            'compactTables' => true,
        ...
        $this->assertStringContainsString('Before<br>', $result->content ?? null);
        $this->assertStringContainsString('<br>', $result->content ?? null);
        $this->assertStringContainsString('123', $result->content ?? null);
        $this->assertStringContainsString('Done', $result->content ?? null);
        $this->assertStringContainsString('Status', $result->content ?? null);
    }
    ...
    public function test_options_custom_bullets_apply_to_layout_table_rows(): void
    {
        ...
        $this->assertStringContainsString('* alpha', $result->content ?? null);
        $this->assertStringNotContainsString('- alpha', $result->content ?? null);
    }
    ...
    public function test_options_extract_metadata_true(): void
    {
        ...
        $this->assertNotSame('', $result->content ?? null ?? '', 'expected non-empty value');
        $this->assertEquals('Test Page', $result->getMetadata()->getDocument()->title ?? null);
        $this->assertEquals('A test page', $result->getMetadata()->getDocument()->description ?? null);
    }
