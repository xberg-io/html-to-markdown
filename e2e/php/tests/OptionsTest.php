...
// alef:hash:1c8d13f451976d41ec2390cecc41a890cf6d9c7a6fcd9f49051f7229a6b1c43f
...
final class OptionsTest extends TestCase
{
    ...
    {
        $builder = $this->createDefaultOptionsBuilder();
        $preprocessing = $this->createPreprocessingOptions(true, "Aggressive", true, true);
    ...
    {
        $builder = $this->createDefaultOptionsBuilder();
        $preprocessing = $this->createPreprocessingOptions(true, "Minimal", true, true);
        $builder = $builder->preprocessing($preprocessing);
        $options = $builder->build();
