...
// alef:hash:60a9e11a2387d0bd2a711b09b3d78c0f7d73c60b9a55023bd15ad01157884248
...
final class MetadataTest extends TestCase
{
    ...
    public function test_metadata_author_meta(): void
    {
        ...
        $this->assertEquals('Jane Doe', $result->getMetadata()->getDocument()->author ?? null);
    }
    ...
    public function test_metadata_canonical_url(): void
    {
        ...
        $this->assertEquals(
            ...
            $result->getMetadata()->getDocument()->canonicalUrl ?? null,
        );
    }
    ...
    public function test_metadata_description_meta(): void
    {
        ...
        $this->assertEquals(
            ...
            $result->getMetadata()->getDocument()->description ?? null,
        );
    }
    ...
    public function test_metadata_extract_all_images(): void
    {
        ...
        $metadataImages = $result->getMetadata()->getImages();

        $this->assertNotSame('', $result->content ?? null ?? '', 'expected non-empty value');
        $this->assertGreaterThanOrEqual(2, count($metadataImages));
    }
    ...
    public function test_metadata_extract_all_links(): void
    {
        ...
        $metadataLinks = $result->getMetadata()->getLinks();

        $this->assertNotSame('', $result->content ?? null ?? '', 'expected non-empty value');
        $this->assertGreaterThanOrEqual(2, count($metadataLinks));
    }
    ...
    public function test_metadata_headers_hierarchy(): void
    {
        ...
        $metadataHeadings = $result->getMetadata()->getHeaders();

        $this->assertNotSame('', $result->content ?? null ?? '', 'expected non-empty value');
        $this->assertGreaterThanOrEqual(5, count($metadataHeadings));
    }
    ...
    public function test_metadata_image_type_data_uri_classified(): void
    {
        ...
        $this->assertNotSame('', $result->content ?? null ?? '', 'expected non-empty value');
        $this->assertGreaterThanOrEqual(1, count($metadataImages));
    }
    ...
    public function test_metadata_keywords_meta(): void
    {
        ...
        $metadataDocumentKeywords = $result->getMetadata()->getDocument()->keywords;

        $this->assertNotSame('', $result->content ?? null ?? '', 'expected non-empty value');
        $this->assertGreaterThanOrEqual(1, count($metadataDocumentKeywords));
    }
    ...
    public function test_metadata_link_type_anchor_classified(): void
    {
        ...
        $this->assertNotSame('', $result->content ?? null ?? '', 'expected non-empty value');
        $this->assertGreaterThanOrEqual(1, count($metadataLinks));
    }
    ...
    public function test_metadata_title_tag(): void
    {
        ...
        $this->assertNotSame('', $result->content ?? null ?? '', 'expected non-empty value');
        $this->assertEquals('My Page', $result->getMetadata()->getDocument()->title ?? null);
    }
    ...
    public function test_og_basic_tags(): void
    {
        ...
        $this->assertNotSame('', $result->content ?? null ?? '', 'expected non-empty value');
        $this->assertEquals('OG Title', $result->getMetadata()->getDocument()->openGraph['title']);
        $this->assertEquals('OG description text.', $result->getMetadata()->getDocument()->openGraph['description']);
        $this->assertEquals('https://example.com/image.jpg', $result->getMetadata()->getDocument()->openGraph['image']);
    }
    ...
    public function test_og_multiple_tags(): void
    {
        ...
        $this->assertNotSame('', $result->content ?? null ?? '', 'expected non-empty value');
        $this->assertEquals('Article Title', $result->getMetadata()->getDocument()->openGraph['title']);
        $this->assertEquals('article', $result->getMetadata()->getDocument()->openGraph['type']);
        $this->assertEquals('https://example.com/article', $result->getMetadata()->getDocument()->openGraph['url']);
        $this->assertEquals('Example Site', $result->getMetadata()->getDocument()->openGraph['site_name']);
    }
    ...
    public function test_twitter_card_tags(): void
    {
        ...
        $this->assertNotSame('', $result->content ?? null ?? '', 'expected non-empty value');
        $this->assertEquals('summary_large_image', $result->getMetadata()->getDocument()->twitterCard['card']);
        $this->assertEquals('Twitter Card Title', $result->getMetadata()->getDocument()->twitterCard['title']);
        $this->assertEquals(
            'Twitter card description.',
            $result->getMetadata()->getDocument()->twitterCard['description'],
        );
    }
}
