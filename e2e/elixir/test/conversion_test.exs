...
# alef:hash:3b3e2c086ad8fa5c751b03f2f483c8a0a8ba82cea495432b27767580da162abc
...
defmodule E2e.ConversionTest do
  ...
  describe "form_input_elements" do
    test "form_input_elements" do
      ...
      {:ok, result} = HtmlToMarkdown.convert("<form><label for=\"name\">Name:</label><input type=\"text\" id=\"name\" placeholder=\"Enter name\"></form>", options: options)
      assert result.content != ""
  ...
  describe "form_select_options" do
    test "form_select_options" do
      options = %HtmlToMarkdown.ConversionOptions{preprocessing: %{"remove_forms" => false}}
      {:ok, result} = HtmlToMarkdown.convert("<form><label>Color:</label><select><option value=\"red\">Red</option><option value=\"blue\" selected>Blue</option><option value=\"green\">Green</option></select></form>", options: options)
      assert result.content != ""
  ...
  describe "form_textarea" do
    test "form_textarea" do
      options = %HtmlToMarkdown.ConversionOptions{preprocessing: %{"remove_forms" => false}}
      {:ok, result} = HtmlToMarkdown.convert("<form><label>Message:</label><textarea>Default text content</textarea></form>", options: options)
      assert result.content != ""
