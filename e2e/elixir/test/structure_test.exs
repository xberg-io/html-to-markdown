...
# alef:hash:90ebe3c2f5b14d3140717fe5ae3091b57716ef810da694e57a7823c37fe54a22
...
defmodule E2e.StructureTest do
  ...
  describe "structure_code_block" do
    test "structure_code_block" do
      ...
      assert result.document.nodes not in [nil, "", [], %{}]
  ...
  describe "structure_h1_h2_nested_group" do
    test "structure_h1_h2_nested_group" do
      ...
      {:ok, result} =
        HtmlToMarkdown.convert("<h1>Chapter One</h1><p>Chapter intro.</p><h2>Section One</h2><p>Section content.</p>", options_value)
