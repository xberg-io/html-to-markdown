...
# alef:hash:4f9673beee6f4b82c9a62f6fc6f628d4b2e78514871ae1c2c8e1c6f65c3de84d
...
defmodule E2e.MetadataTest do
  ...
  describe "metadata_author_meta" do
    test "metadata_author_meta" do
      ...
      assert result.metadata.document.author == "Jane Doe"
    end
  end
  ...
  describe "metadata_canonical_url" do
    test "metadata_canonical_url" do
      ...
      assert result.content not in [nil, "", [], %{}]
      assert result.metadata.document.canonical_url == "https://example.com/canonical-page"
    end
  end
  ...
  describe "metadata_description_meta" do
    test "metadata_description_meta" do
      ...
      assert result.content not in [nil, "", [], %{}]
      assert result.metadata.document.description == "This is the page description."
    end
  end
  ...
  describe "metadata_title_tag" do
    test "metadata_title_tag" do
      ...
      assert result.content not in [nil, "", [], %{}]
      assert result.metadata.document.title == "My Page"
    end
  end
  ...
  describe "og_basic_tags" do
    test "og_basic_tags" do
      ...
      assert result.content not in [nil, "", [], %{}]
      assert result.metadata.document.open_graph["title"] == "OG Title"
      assert result.metadata.document.open_graph["description"] == "OG description text."
      assert result.metadata.document.open_graph["image"] == "https://example.com/image.jpg"
    end
  end
  ...
  describe "og_multiple_tags" do
    test "og_multiple_tags" do
      ...
      assert result.content not in [nil, "", [], %{}]
      assert result.metadata.document.open_graph["title"] == "Article Title"
      assert result.metadata.document.open_graph["type"] == "article"
      assert result.metadata.document.open_graph["url"] == "https://example.com/article"
      assert result.metadata.document.open_graph["site_name"] == "Example Site"
    end
  end
  ...
  describe "structured_data_json_ld" do
    test "structured_data_json_ld" do
      ...
      refute String.contains?(to_string(result.content), "application/ld+json")
      refute String.contains?(to_string(result.content), "@context")
      refute String.contains?(to_string(result.content), "schema.org")
    end
  end
  ...
  describe "structured_data_multiple_json_ld" do
    test "structured_data_multiple_json_ld" do
      ...
      refute String.contains?(to_string(result.content), "@context")
      refute String.contains?(to_string(result.content), "BreadcrumbList")
      refute String.contains?(to_string(result.content), "ListItem")
    end
  end
  ...
  describe "twitter_card_tags" do
    test "twitter_card_tags" do
      ...
      assert result.content not in [nil, "", [], %{}]
      assert result.metadata.document.twitter_card["card"] == "summary_large_image"
      assert result.metadata.document.twitter_card["title"] == "Twitter Card Title"
      assert result.metadata.document.twitter_card["description"] == "Twitter card description."
    end
  end
end
