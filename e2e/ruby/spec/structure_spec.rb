...
# alef:hash:efe6bdffffe47311fa853d691fba8f6e7881e2693070a47e15e68b5ac3a2c0c9
...
RSpec.describe "structure" do
  ...
  it "structure_code_block: Fenced code block produces Code node" do
    ...
    expect(result.document.nodes.respond_to?(:empty?) ? !result.document.nodes.empty? : !result.document.nodes.nil?).to(
      be(true)
    )
