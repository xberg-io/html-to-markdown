...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/kreuzberg-dev/html-to-markdown/releases/download/v3.6.3/HtmlToMarkdown-rs.artifactbundle.zip",
      checksum: "5b0e7b44c9dd784563f0306259924e6779c4be616555ac490483b63233fa2a52"
    ),
