...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/kreuzberg-dev/html-to-markdown/releases/download/v3.6.7/HtmlToMarkdown-rs.artifactbundle.zip",
      checksum: "a1f573952c2936317eefbed71fcac161d881640dfce401889226cdb1e0f793c1"
    ),
