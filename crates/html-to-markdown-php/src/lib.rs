...
// alef:hash:9faecd8bc2c34df69e7a6c32a6d35b5c230123018b08a1c8405e2342684e1295
    ...
    fn from(val: html_to_markdown_rs::NodeContent) -> Self {
        match val {
            ...
            html_to_markdown_rs::NodeContent::Image {
                ...
                image_index: image_index.map(Into::into),
                ..Default::default()
            },
            ...
            html_to_markdown_rs::NodeContent::Group {
                ...
                heading_level: heading_level.map(Into::into),
                heading_text: heading_text.map(Into::into),
                ..Default::default()
            },
        }
    }
    ...
    fn from(val: NodeContent) -> Self {
        match val.node_type_tag.as_str() {
            "heading" => html_to_markdown_rs::NodeContent::Heading {
                ...
                text: val.text.map(Into::into).unwrap_or_default(),
            },
            "paragraph" => html_to_markdown_rs::NodeContent::Paragraph {
                text: val.text.map(Into::into).unwrap_or_default(),
            },
            "list" => html_to_markdown_rs::NodeContent::List {
                ordered: val.ordered.map(Into::into).unwrap_or_default(),
            },
            ...
            "image" => html_to_markdown_rs::NodeContent::Image {
                ...
                src: val.src.map(Into::into),
                image_index: val.image_index.map(Into::into),
            },
            "code" => html_to_markdown_rs::NodeContent::Code {
                text: val.text.map(Into::into).unwrap_or_default(),
                language: val.language.map(Into::into),
            },
            ...
            "definition_item" => html_to_markdown_rs::NodeContent::DefinitionItem {
                term: val.term.map(Into::into).unwrap_or_default(),
                definition: val.definition.map(Into::into).unwrap_or_default(),
            },
            ...
            "metadata_block" => html_to_markdown_rs::NodeContent::MetadataBlock {
                entries: val.entries.map(Into::into).unwrap_or_default(),
            },
            "group" => html_to_markdown_rs::NodeContent::Group {
                label: val.label.map(Into::into),
                heading_level: val.heading_level.map(Into::into),
                heading_text: val.heading_text.map(Into::into),
            },
    ...
    fn from(val: AnnotationKind) -> Self {
        match val.annotation_type_tag.as_str() {
            ...
            "link" => html_to_markdown_rs::AnnotationKind::Link {
                url: val.url.map(Into::into).unwrap_or_default(),
                title: val.title.map(Into::into),
            },
