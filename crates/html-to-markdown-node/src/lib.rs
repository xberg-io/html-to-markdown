...
// alef:hash:eb3dc1445cf378256cad63e29fb88d239810b0f6f737f7dac53a5bff3eb6b245
...
impl html_to_markdown_rs::visitor::HtmlVisitor for JsHtmlVisitorBridge {
    ...
    fn visit_element_end(
        ...
        let result = func.call((arg_0, arg_1).into());
        match result {
            Err(_) => html_to_markdown_rs::VisitResult::Continue,
            Ok(val) => {
                if let Ok(obj) = val.coerce_to_object() {
    ...
    fn visit_link(
        ...
        let result = func.call((arg_0, arg_1, arg_2, arg_3).into());
        match result {
            Err(_) => html_to_markdown_rs::VisitResult::Continue,
            Ok(val) => {
                if let Ok(obj) = val.coerce_to_object() {
    ...
    fn visit_code_block(
        ...
        let result = func.call((arg_0, arg_1, arg_2).into());
        match result {
            Err(_) => html_to_markdown_rs::VisitResult::Continue,
            Ok(val) => {
                if let Ok(obj) = val.coerce_to_object() {
