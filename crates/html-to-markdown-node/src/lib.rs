...
// alef:hash:9413b7a8e5a74f38bb142bb898309b496aaf644e93583d56119fd7e3a8fa5d60
...
pub struct JsConversionOptions {
    ...
    #[napi(
        js_name = "headingStyle",
        ts_type = "HeadingStyle | 'Underlined' | 'Atx' | 'AtxClosed'"
    )]
    pub heading_style: Option<JsHeadingStyle>,
    /// How to indent nested list items (spaces or tab).
    #[napi(js_name = "listIndentType", ts_type = "ListIndentType | 'Spaces' | 'Tabs'")]
    ...
    #[napi(
        js_name = "highlightStyle",
        ts_type = "HighlightStyle | 'DoubleEqual' | 'Html' | 'Bold' | 'None'"
    )]
    ...
    #[napi(js_name = "whitespaceMode", ts_type = "WhitespaceMode | 'Normalized' | 'Strict'")]
    ...
    #[napi(js_name = "newlineStyle", ts_type = "NewlineStyle | 'Spaces' | 'Backslash'")]
    pub newline_style: Option<JsNewlineStyle>,
    /// Style used for fenced code blocks (backticks or tilde).
    #[napi(
        js_name = "codeBlockStyle",
        ts_type = "CodeBlockStyle | 'Indented' | 'Backticks' | 'Tildes'"
    )]
    ...
    #[napi(js_name = "urlEscapeStyle", ts_type = "UrlEscapeStyle | 'Angle' | 'Percent'")]
    pub url_escape_style: Option<JsUrlEscapeStyle>,
    /// Link rendering style (inline or reference).
    #[napi(js_name = "linkStyle", ts_type = "LinkStyle | 'Inline' | 'Reference'")]
    pub link_style: Option<JsLinkStyle>,
    /// Target output format (Markdown, plain text, etc.).
    #[napi(js_name = "outputFormat", ts_type = "OutputFormat | 'Markdown' | 'Djot' | 'Plain'")]
    ...
    #[napi(js_name = "tierStrategy", ts_type = "TierStrategy | 'auto' | 'tier_2' | 'tier_1'")]
...
pub struct JsDocumentMetadata {
    ...
    #[napi(js_name = "textDirection", ts_type = "TextDirection | 'ltr' | 'rtl' | 'auto'")]
...
impl<'de> serde::Deserialize<'de> for JsDocumentNode {
...
impl<'de> serde::Deserialize<'de> for JsGridCell {
    fn deserialize<D>(deserializer: D) -> ::core::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
...
pub struct JsImageMetadata {
    ...
    #[napi(
        js_name = "imageType",
        ts_type = "ImageType | 'data_uri' | 'inline_svg' | 'external' | 'relative'"
    )]
...
pub struct JsLinkMetadata {
    ...
    #[napi(
        js_name = "linkType",
        ts_type = "LinkType | 'anchor' | 'internal' | 'external' | 'email' | 'phone' | 'other'"
    )]
...
pub struct JsPreprocessingOptions {
    ...
    #[napi(ts_type = "PreprocessingPreset | 'Minimal' | 'Standard' | 'Aggressive'")]
...
impl<'de> serde::Deserialize<'de> for JsPreprocessingOptions {
    fn deserialize<D>(deserializer: D) -> ::core::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
...
pub struct JsProcessingWarning {
    ...
    #[napi(
        ts_type = "WarningKind | 'image_extraction_failed' | 'encoding_fallback' | 'truncated_input' | 'malformed_html' | 'sanitization_applied' | 'depth_limit_exceeded'"
    )]
...
pub struct JsStructuredData {
    ...
    #[napi(
        js_name = "dataType",
        ts_type = "StructuredDataType | 'json_ld' | 'microdata' | 'rdfa'"
    )]
...
#[napi(string_enum = "snake_case", js_name = "TierStrategy")]
#[derive(Clone, serde::Serialize, serde::Deserialize)]
...
#[derive(Clone, serde::Serialize, serde::Deserialize)]
#[napi(object, js_name = "VisitResult")]
...
impl html_to_markdown_rs::visitor::HtmlVisitor for JsHtmlVisitorBridge {
    fn visit_text(&mut self, _ctx: &html_to_markdown_rs::NodeContext, _text: &str) -> html_to_markdown_rs::VisitResult {
        ...
        let arg_1: napi::bindgen_prelude::Unknown = unsafe {
            let r =
                napi::bindgen_prelude::ToNapiValue::to_napi_value(__env.raw(), _text).unwrap_or(std::ptr::null_mut());
            napi::bindgen_prelude::Unknown::from_raw_unchecked(__env.raw(), r)
        };
    ...
    fn visit_element_end(
        ...
        let arg_1: napi::bindgen_prelude::Unknown = unsafe {
            let r =
                napi::bindgen_prelude::ToNapiValue::to_napi_value(__env.raw(), _output).unwrap_or(std::ptr::null_mut());
            napi::bindgen_prelude::Unknown::from_raw_unchecked(__env.raw(), r)
        };
        let result = func.call(napi::bindgen_prelude::FnArgs::from((arg_0, arg_1)));
    ...
    fn visit_link(
        ...
        let arg_1: napi::bindgen_prelude::Unknown = unsafe {
            let r =
                napi::bindgen_prelude::ToNapiValue::to_napi_value(__env.raw(), _href).unwrap_or(std::ptr::null_mut());
            napi::bindgen_prelude::Unknown::from_raw_unchecked(__env.raw(), r)
        };
        ...
        let arg_3: napi::bindgen_prelude::Unknown = match _title {
            Some(s) => unsafe {
                let r =
                    napi::bindgen_prelude::ToNapiValue::to_napi_value(__env.raw(), s).unwrap_or(std::ptr::null_mut());
                napi::bindgen_prelude::Unknown::from_raw_unchecked(__env.raw(), r)
            },
            None => unsafe {
                let r = napi::bindgen_prelude::ToNapiValue::to_napi_value(__env.raw(), napi::bindgen_prelude::Null)
    ...
    fn visit_image(
        ...
        let arg_1: napi::bindgen_prelude::Unknown = unsafe {
            let r =
                napi::bindgen_prelude::ToNapiValue::to_napi_value(__env.raw(), _src).unwrap_or(std::ptr::null_mut());
            napi::bindgen_prelude::Unknown::from_raw_unchecked(__env.raw(), r)
        };
        let arg_2: napi::bindgen_prelude::Unknown = unsafe {
            let r =
                napi::bindgen_prelude::ToNapiValue::to_napi_value(__env.raw(), _alt).unwrap_or(std::ptr::null_mut());
            napi::bindgen_prelude::Unknown::from_raw_unchecked(__env.raw(), r)
        };
        let arg_3: napi::bindgen_prelude::Unknown = match _title {
            Some(s) => unsafe {
    ...
    fn visit_heading(
        ...
        let arg_1: napi::bindgen_prelude::Unknown = unsafe {
            let r =
                napi::bindgen_prelude::ToNapiValue::to_napi_value(__env.raw(), _level).unwrap_or(std::ptr::null_mut());
            napi::bindgen_prelude::Unknown::from_raw_unchecked(__env.raw(), r)
        };
        let arg_2: napi::bindgen_prelude::Unknown = unsafe {
            let r =
    ...
    fn visit_code_block(
        ...
        let arg_2: napi::bindgen_prelude::Unknown = unsafe {
            let r =
                napi::bindgen_prelude::ToNapiValue::to_napi_value(__env.raw(), _code).unwrap_or(std::ptr::null_mut());
            napi::bindgen_prelude::Unknown::from_raw_unchecked(__env.raw(), r)
        };
    ...
    fn visit_list_item(
        ...
        let arg_2: napi::bindgen_prelude::Unknown = unsafe {
            let r =
                napi::bindgen_prelude::ToNapiValue::to_napi_value(__env.raw(), _marker).unwrap_or(std::ptr::null_mut());
            napi::bindgen_prelude::Unknown::from_raw_unchecked(__env.raw(), r)
        };
        let arg_3: napi::bindgen_prelude::Unknown = unsafe {
            let r =
                napi::bindgen_prelude::ToNapiValue::to_napi_value(__env.raw(), _text).unwrap_or(std::ptr::null_mut());
            napi::bindgen_prelude::Unknown::from_raw_unchecked(__env.raw(), r)
        };
    ...
    fn visit_table_row(
        ...
        let arg_1: napi::bindgen_prelude::Unknown = unsafe {
            let r = napi::bindgen_prelude::ToNapiValue::to_napi_value(__env.raw(), _cells.to_vec())
                .unwrap_or(std::ptr::null_mut());
            napi::bindgen_prelude::Unknown::from_raw_unchecked(__env.raw(), r)
        };
        let arg_2: napi::bindgen_prelude::Unknown = unsafe {
    ...
    fn visit_blockquote(
        ...
        let arg_1: napi::bindgen_prelude::Unknown = unsafe {
            let r = napi::bindgen_prelude::ToNapiValue::to_napi_value(__env.raw(), _content)
                .unwrap_or(std::ptr::null_mut());
            napi::bindgen_prelude::Unknown::from_raw_unchecked(__env.raw(), r)
        };
        let arg_2: napi::bindgen_prelude::Unknown = unsafe {
            let r = napi::bindgen_prelude::ToNapiValue::to_napi_value(__env.raw(), _depth as u32)
                .unwrap_or(std::ptr::null_mut());
            napi::bindgen_prelude::Unknown::from_raw_unchecked(__env.raw(), r)
        };
        let result = func.call(napi::bindgen_prelude::FnArgs::from((arg_0, arg_1, arg_2)));
    ...
    fn visit_custom_element(
        ...
        let arg_1: napi::bindgen_prelude::Unknown = unsafe {
            let r = napi::bindgen_prelude::ToNapiValue::to_napi_value(__env.raw(), _tag_name)
                .unwrap_or(std::ptr::null_mut());
            napi::bindgen_prelude::Unknown::from_raw_unchecked(__env.raw(), r)
        };
        let arg_2: napi::bindgen_prelude::Unknown = unsafe {
            let r =
                napi::bindgen_prelude::ToNapiValue::to_napi_value(__env.raw(), _html).unwrap_or(std::ptr::null_mut());
            napi::bindgen_prelude::Unknown::from_raw_unchecked(__env.raw(), r)
        };
        let result = func.call(napi::bindgen_prelude::FnArgs::from((arg_0, arg_1, arg_2)));
    ...
    fn visit_input(
        ...
        let arg_1: napi::bindgen_prelude::Unknown = unsafe {
            let r = napi::bindgen_prelude::ToNapiValue::to_napi_value(__env.raw(), _input_type)
                .unwrap_or(std::ptr::null_mut());
            napi::bindgen_prelude::Unknown::from_raw_unchecked(__env.raw(), r)
        };
...
pub const CONVERSION_ERROR_ERROR_PARSE_ERROR_CODE: u32 = 2;
pub const CONVERSION_ERROR_ERROR_SANITIZATION_ERROR: &str = "SanitizationError";
pub const CONVERSION_ERROR_ERROR_SANITIZATION_ERROR_CODE: u32 = 2;
pub const CONVERSION_ERROR_ERROR_CONFIG_ERROR: &str = "ConfigError";
pub const CONVERSION_ERROR_ERROR_CONFIG_ERROR_CODE: u32 = 2;
pub const CONVERSION_ERROR_ERROR_IO_ERROR: &str = "IoError";
pub const CONVERSION_ERROR_ERROR_IO_ERROR_CODE: u32 = 2;
pub const CONVERSION_ERROR_ERROR_PANIC: &str = "Panic";
pub const CONVERSION_ERROR_ERROR_PANIC_CODE: u32 = 2;
pub const CONVERSION_ERROR_ERROR_INVALID_INPUT: &str = "InvalidInput";
pub const CONVERSION_ERROR_ERROR_INVALID_INPUT_CODE: u32 = 2;
pub const CONVERSION_ERROR_ERROR_OTHER: &str = "Other";
pub const CONVERSION_ERROR_ERROR_OTHER_CODE: u32 = 2;
