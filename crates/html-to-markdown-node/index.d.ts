...
// alef:hash:cc8185abf6cbfb4c7d5cbb683a3669c387daf293975260c10c4127c9431c6179
...
export declare const VisitResult: {
  readonly Continue: VisitResult;
  Custom(output: string): VisitResult;
  readonly Skip: VisitResult;
  readonly PreserveHtml: VisitResult;
  Error(output: string): VisitResult;
};
