...
export interface HtmlVisitor {
   ...
   */
  visit_text?(ctx: NodeContext, text: string): string
  /**
   ...
   */
  visit_element_start?(ctx: NodeContext): string
  /**
   ...
   */
  visit_element_end?(ctx: NodeContext, output: string): string
  /**
   ...
   */
  visit_link?(ctx: NodeContext, href: string, text: string, title?: string | undefined | null): string
  /**
   ...
   * @param title - Optional title attribute
   */
  visit_image?(ctx: NodeContext, src: string, alt: string, title?: string | undefined | null): string
  /**
   ...
   */
  visit_heading?(ctx: NodeContext, level: number, text: string, id?: string | undefined | null): string
  /**
   ...
   */
  visit_code_block?(ctx: NodeContext, code: string, lang?: string | undefined | null): string
  /**
   ...
   * @param code - The code content
   */
  visit_code_inline?(ctx: NodeContext, code: string): string
  /**
   * Visit list items `<li>`.
   * @param ctx - Node context
   *
   ...
   */
  visit_list_item?(ctx: NodeContext, ordered: boolean, marker: string, text: string): string
  /** Called before processing a list `<ul>` or `<ol>`. */
  visit_list_start?(ctx: NodeContext, ordered: boolean): string
  /** Called after processing a list `</ul>` or `</ol>`. */
  visit_list_end?(ctx: NodeContext, ordered: boolean, output: string): string
  /** Called before processing a table `<table>`. */
  visit_table_start?(ctx: NodeContext): string
  /**
   * Visit table rows `<tr>`.
   * @param ctx - Node context
   *
   ...
   */
  visit_table_row?(ctx: NodeContext, cells: Array<string>, isHeader: boolean): string
  /** Called after processing a table `</table>`. */
  visit_table_end?(ctx: NodeContext, output: string): string
  /**
   ...
   */
  visit_blockquote?(ctx: NodeContext, content: string, depth: number): string
  /** Visit strong/bold elements `<strong>`, `<b>`. */
  visit_strong?(ctx: NodeContext, text: string): string
  /** Visit emphasis/italic elements `<em>`, `<i>`. */
  visit_emphasis?(ctx: NodeContext, text: string): string
  /** Visit strikethrough elements `<s>`, `<del>`, `<strike>`. */
  visit_strikethrough?(ctx: NodeContext, text: string): string
  /** Visit underline elements `<u>`, `<ins>`. */
  visit_underline?(ctx: NodeContext, text: string): string
  /** Visit subscript elements `<sub>`. */
  visit_subscript?(ctx: NodeContext, text: string): string
  /** Visit superscript elements `<sup>`. */
  visit_superscript?(ctx: NodeContext, text: string): string
  /** Visit mark/highlight elements `<mark>`. */
  visit_mark?(ctx: NodeContext, text: string): string
  /** Visit line break elements `<br>`. */
  visit_line_break?(ctx: NodeContext): string
  /** Visit horizontal rule elements `<hr>`. */
  visit_horizontal_rule?(ctx: NodeContext): string
  /**
   ...
   */
  visit_custom_element?(ctx: NodeContext, tagName: string, html: string): string
  /** Visit definition list `<dl>`. */
  visit_definition_list_start?(ctx: NodeContext): string
  /** Visit definition term `<dt>`. */
  visit_definition_term?(ctx: NodeContext, text: string): string
  /** Visit definition description `<dd>`. */
  visit_definition_description?(ctx: NodeContext, text: string): string
  /** Called after processing a definition list `</dl>`. */
  visit_definition_list_end?(ctx: NodeContext, output: string): string
  /** Visit form elements `<form>`. */
  visit_form?(ctx: NodeContext, action?: string | undefined | null, method?: string | undefined | null): string
  /** Visit input elements `<input>`. */
  visit_input?(ctx: NodeContext, inputType: string, name?: string | undefined | null, value?: string | undefined | null): string
  /** Visit button elements `<button>`. */
  visit_button?(ctx: NodeContext, text: string): string
  /** Visit audio elements `<audio>`. */
  visit_audio?(ctx: NodeContext, src?: string | undefined | null): string
  /** Visit video elements `<video>`. */
  visit_video?(ctx: NodeContext, src?: string | undefined | null): string
  /** Visit iframe elements `<iframe>`. */
  visit_iframe?(ctx: NodeContext, src?: string | undefined | null): string
  /** Visit details elements `<details>`. */
  visit_details?(ctx: NodeContext, open: boolean): string
  /** Visit summary elements `<summary>`. */
  visit_summary?(ctx: NodeContext, text: string): string
  /** Visit figure elements `<figure>`. */
  visit_figure_start?(ctx: NodeContext): string
  /** Visit figcaption elements `<figcaption>`. */
  visit_figcaption?(ctx: NodeContext, text: string): string
  /** Called after processing a figure `</figure>`. */
  visit_figure_end?(ctx: NodeContext, output: string): string
}
