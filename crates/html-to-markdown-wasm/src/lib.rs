...
// alef:hash:c4205fd0f24f510826fb985546a809e8905add0b7bcf01c8d4849cf97f2aefea
...
impl WasmConversionOptions {
    ...
    pub fn new(
        ...
        WasmConversionOptions {
            heading_style: headingStyle.unwrap_or_else(|| {
                <html_to_markdown_rs::options::ConversionOptions as ::core::default::Default>::default()
                    .heading_style
                    .into()
            }),
            list_indent_type: listIndentType.unwrap_or_else(|| {
                <html_to_markdown_rs::options::ConversionOptions as ::core::default::Default>::default()
                    .list_indent_type
                    .into()
            }),
            ...
            highlight_style: highlightStyle.unwrap_or_else(|| {
                <html_to_markdown_rs::options::ConversionOptions as ::core::default::Default>::default()
                    .highlight_style
                    .into()
            }),
            extract_metadata: extractMetadata.unwrap_or(true),
            whitespace_mode: whitespaceMode.unwrap_or_else(|| {
                <html_to_markdown_rs::options::ConversionOptions as ::core::default::Default>::default()
                    .whitespace_mode
                    .into()
            }),
            ...
            newline_style: newlineStyle.unwrap_or_else(|| {
                <html_to_markdown_rs::options::ConversionOptions as ::core::default::Default>::default()
                    .newline_style
                    .into()
            }),
            code_block_style: codeBlockStyle.unwrap_or_else(|| {
                <html_to_markdown_rs::options::ConversionOptions as ::core::default::Default>::default()
                    .code_block_style
                    .into()
            }),
            ...
            url_escape_style: urlEscapeStyle.unwrap_or_else(|| {
                <html_to_markdown_rs::options::ConversionOptions as ::core::default::Default>::default()
                    .url_escape_style
                    .into()
            }),
            link_style: linkStyle.unwrap_or_else(|| {
                <html_to_markdown_rs::options::ConversionOptions as ::core::default::Default>::default()
                    .link_style
                    .into()
            }),
            output_format: outputFormat.unwrap_or_else(|| {
                <html_to_markdown_rs::options::ConversionOptions as ::core::default::Default>::default()
                    .output_format
                    .into()
            }),
            ...
            tier_strategy: tierStrategy.unwrap_or_else(|| {
                <html_to_markdown_rs::options::ConversionOptions as ::core::default::Default>::default()
                    .tier_strategy
                    .into()
            }),
...
impl WasmHeaderMetadata {
    ...
    pub fn is_valid(&self) -> bool {
        html_to_markdown_rs::metadata::HeaderMetadata::from(self.clone()).is_valid()
    }
}
...
impl WasmPreprocessingOptions {
    ...
    pub fn new(
        ...
        WasmPreprocessingOptions {
            ...
            preset: preset.unwrap_or_else(|| {
                <html_to_markdown_rs::options::PreprocessingOptions as ::core::default::Default>::default()
                    .preset
                    .into()
            }),
...
impl WasmVisitResult {
    #[wasm_bindgen(constructor)]
    pub fn new() -> WasmVisitResult {
        Self::default()
    }

    #[wasm_bindgen]
    #[allow(clippy::should_implement_trait)]
    pub fn default() -> WasmVisitResult {
        <Self as ::core::default::Default>::default()
    }
...
impl From<WasmVisitResult> for html_to_markdown_rs::VisitResult {
    fn from(val: WasmVisitResult) -> Self {
        match val.r#type.as_str() {
            "continue" => Self::Continue,
            "custom" => Self::Custom(val._0.clone().unwrap_or_default()),
            "skip" => Self::Skip,
            "preserve_html" => Self::PreserveHtml,
            "error" => Self::Error(val._0.clone().unwrap_or_default()),
            _ => Self::Continue,
        }
    }
}
...
impl From<html_to_markdown_rs::VisitResult> for WasmVisitResult {
    fn from(val: html_to_markdown_rs::VisitResult) -> Self {
        match val {
            ...
            html_to_markdown_rs::VisitResult::Custom(field0) => Self {
            ...
            html_to_markdown_rs::VisitResult::PreserveHtml => Self {
                r#type: "preserve_html".to_string(),
                _0: None,
            },
            html_to_markdown_rs::VisitResult::Error(field0) => Self {
