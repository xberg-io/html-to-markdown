...
// alef:hash:515ea577417652c3da553a2f17d36120c1be25db0a9dc80d2d3ff8b53447ad91
...
if (version_compare($loadedVersion, '3.14.0', '<')) {
    ...
    fwrite(STDERR, "  expected version: >=3.14.0\n");
