...
// alef:hash:5c641d879663b0a346598beb2a7bd2d9786af922e5574bcf654facdb68f8a5d6
...
if (version_compare($loadedVersion, '3.12.4', '<')) {
    ...
    fwrite(STDERR, "  expected version: >=3.12.4\n");
