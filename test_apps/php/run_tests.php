...
// alef:hash:5edad4a03bbac1da7d5a9d97112a95e1e245e715524728c902b7d88a55be7760
...
if (version_compare($loadedVersion, '3.14.3', '<')) {
    ...
    fwrite(STDERR, "  expected version: >=3.14.3\n");
