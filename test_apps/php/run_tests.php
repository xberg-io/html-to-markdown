...
// alef:hash:ac2da537e5e0ab9172ab16162e2ca240515eb218d159c1b3abb2c9259003e0f6
...
if (version_compare($loadedVersion, '3.14.1', '<')) {
    ...
    fwrite(STDERR, "  expected version: >=3.14.1\n");
