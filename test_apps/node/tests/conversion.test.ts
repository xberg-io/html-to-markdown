...
// alef:hash:1f2dfd2d8e373ab8af766205624e622242945057f8e49ad6dd1b2a09d5e2b692
...
describe("conversion", () => {
  ...
  it("image_kept_inline_in_link: keep_inline_images_in naming 'a' keeps an image inside a link that also holds a block element", () => {
    const result = convert('<a href="https://example.com/file.pdf"><img src="pdf.png"><p>Download PDF</p></a>', {
