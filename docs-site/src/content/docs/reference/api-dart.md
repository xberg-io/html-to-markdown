...
<!-- alef:hash:50c85e2dd43bfec603a93f606a053e23c3713142658276b1e26eabad60eb8c15 -->
<!-- To regenerate: alef docs -->
<!-- To verify freshness: alef verify -->

## Dart API Reference <span class="version-badge">v3.15.0</span>
...
```dart
Future<ConversionResult> convert(String html, {ConversionOptions? options})
```
...
| `depth` | `PlatformInt64` | — | Document tree depth at the header element |
| `htmlOffset` | `PlatformInt64` | — | Byte offset in original HTML document |
...
```dart
Future<VisitResult> visitCodeBlock(NodeContext ctx, String code, {String? lang})
```
...
```dart
Future<VisitResult> visitBlockquote(NodeContext ctx, String content, PlatformInt64 depth)
```
...
| `depth` | `PlatformInt64` | Yes | The  depth |
...
| `depth` | `PlatformInt64` | — | Depth in the DOM tree (0 = root) |
| `indexInParent` | `PlatformInt64` | — | Index among siblings (0-based) |
