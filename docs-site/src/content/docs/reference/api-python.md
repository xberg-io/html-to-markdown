...
<!-- alef:hash:b9950d23fa9e68c14c0277a178fe62aef005ceae849964caf64e4edaa77b4891 -->
<!-- To regenerate: alef docs -->
<!-- To verify freshness: alef verify -->

## Python API Reference <span class="version-badge">v3.15.0</span>
...
| `row_span` | `int` | `1` | Number of rows this cell spans (default 1). |
| `col_span` | `int` | `1` | Number of columns this cell spans (default 1). |
...
| `CUSTOM` | Replace default output with custom markdown The visitor takes full responsibility for the markdown output of this node and its children. — Fields: `output`: `str` |
...
| `ERROR` | Stop conversion with an error The conversion process halts and returns this error message. — Fields: `output`: `str` |
...
| `PanicError(ConversionError)` | Internal error caught during conversion |
| `InvalidInputError(ConversionError)` | Invalid input data |
| `OtherError(ConversionError)` | Generic conversion error |
