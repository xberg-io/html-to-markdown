...
<!-- alef:hash:6fa2e0d6d2d41f01cc6b9a328e29987f66dda4004d6ec3915925692808969393 -->
<!-- To regenerate: alef docs -->
<!-- To verify freshness: alef verify -->

## Rust API Reference <span class="version-badge">v3.15.0</span>
...
```rust
pub fn convert(html: &str, options: Option<ConversionOptions>) -> Result<ConversionResult, ConversionError>
```
...
**Errors:** Returns `Err(ConversionError)`.
...
| `tables` | `Vec<TableData>` | `vec![]` | Extracted tables with structured cell data and markdown representation. Table data is collected by the same pass that builds `Self::document`, so it is populated only when `ConversionOptions::include_document_structure` is `true`. With the default options this is an empty vec even for input that contains tables — the tables still appear in `Self::content` as rendered Markdown. |
| `images` | `Vec<InlineImage>` | `vec![]` | Extracted inline images from data URIs and SVGs. Populated when the `inline-images` feature is enabled and `extract_images` is `true`. Bindings may expose a simplified image representation or omit this Rust-only payload depending on backend support for binary image data. |
...
```rust
pub fn visit_text(&mut self, ctx: &NodeContext, text: &str) -> VisitResult
```
...
```rust
pub fn visit_element_start(&mut self, ctx: &NodeContext) -> VisitResult
```
...
```rust
pub fn visit_element_end(&mut self, ctx: &NodeContext, output: &str) -> VisitResult
```
...
```rust
pub fn visit_link(&mut self, ctx: &NodeContext, href: &str, text: &str, title: Option<&str>) -> VisitResult
```
...
```rust
pub fn visit_image(&mut self, ctx: &NodeContext, src: &str, alt: &str, title: Option<&str>) -> VisitResult
```
...
```rust
pub fn visit_heading(&mut self, ctx: &NodeContext, level: u32, text: &str, id: Option<&str>) -> VisitResult
```
...
```rust
pub fn visit_code_block(&mut self, ctx: &NodeContext, lang: Option<&str>, code: &str) -> VisitResult
```
...
```rust
pub fn visit_code_inline(&mut self, ctx: &NodeContext, code: &str) -> VisitResult
```
...
```rust
pub fn visit_list_item(&mut self, ctx: &NodeContext, ordered: bool, marker: &str, text: &str) -> VisitResult
```
...
```rust
pub fn visit_list_start(&mut self, ctx: &NodeContext, ordered: bool) -> VisitResult
```
...
```rust
pub fn visit_list_end(&mut self, ctx: &NodeContext, ordered: bool, output: &str) -> VisitResult
```
...
```rust
pub fn visit_table_start(&mut self, ctx: &NodeContext) -> VisitResult
```
...
```rust
pub fn visit_table_row(&mut self, ctx: &NodeContext, cells: &[String], is_header: bool) -> VisitResult
```
...
```rust
pub fn visit_table_end(&mut self, ctx: &NodeContext, output: &str) -> VisitResult
```
...
```rust
pub fn visit_blockquote(&mut self, ctx: &NodeContext, content: &str, depth: usize) -> VisitResult
```
...
```rust
pub fn visit_strong(&mut self, ctx: &NodeContext, text: &str) -> VisitResult
```
...
```rust
pub fn visit_emphasis(&mut self, ctx: &NodeContext, text: &str) -> VisitResult
```
...
```rust
pub fn visit_strikethrough(&mut self, ctx: &NodeContext, text: &str) -> VisitResult
```
...
```rust
pub fn visit_underline(&mut self, ctx: &NodeContext, text: &str) -> VisitResult
```
...
```rust
pub fn visit_subscript(&mut self, ctx: &NodeContext, text: &str) -> VisitResult
```
...
```rust
pub fn visit_superscript(&mut self, ctx: &NodeContext, text: &str) -> VisitResult
```
...
```rust
pub fn visit_mark(&mut self, ctx: &NodeContext, text: &str) -> VisitResult
```
...
```rust
pub fn visit_line_break(&mut self, ctx: &NodeContext) -> VisitResult
```
...
```rust
pub fn visit_horizontal_rule(&mut self, ctx: &NodeContext) -> VisitResult
```
...
```rust
pub fn visit_custom_element(&mut self, ctx: &NodeContext, tag_name: &str, html: &str) -> VisitResult
```
...
```rust
pub fn visit_definition_list_start(&mut self, ctx: &NodeContext) -> VisitResult
```
...
```rust
pub fn visit_definition_term(&mut self, ctx: &NodeContext, text: &str) -> VisitResult
```
...
```rust
pub fn visit_definition_description(&mut self, ctx: &NodeContext, text: &str) -> VisitResult
```
...
```rust
pub fn visit_definition_list_end(&mut self, ctx: &NodeContext, output: &str) -> VisitResult
```
...
```rust
pub fn visit_form(&mut self, ctx: &NodeContext, action: Option<&str>, method: Option<&str>) -> VisitResult
```
...
|------|------|----------|-------------|
| `ctx` | `&NodeContext` | Yes | The node context |
| `action` | `Option<&str>` | No | The  action |
| `method` | `Option<&str>` | No | The  method |
...
```rust
pub fn visit_input(&mut self, ctx: &NodeContext, input_type: &str, name: Option<&str>, value: Option<&str>) -> VisitResult
```
...
| `name` | `Option<&str>` | No | The  name |
| `value` | `Option<&str>` | No | The  value |
...
```rust
pub fn visit_button(&mut self, ctx: &NodeContext, text: &str) -> VisitResult
```
...
```rust
pub fn visit_audio(&mut self, ctx: &NodeContext, src: Option<&str>) -> VisitResult
```
...
```rust
pub fn visit_video(&mut self, ctx: &NodeContext, src: Option<&str>) -> VisitResult
```
...
```rust
pub fn visit_iframe(&mut self, ctx: &NodeContext, src: Option<&str>) -> VisitResult
```
...
```rust
pub fn visit_details(&mut self, ctx: &NodeContext, open: bool) -> VisitResult
```
...
```rust
pub fn visit_summary(&mut self, ctx: &NodeContext, text: &str) -> VisitResult
```
...
```rust
pub fn visit_figure_start(&mut self, ctx: &NodeContext) -> VisitResult
```
...
```rust
pub fn visit_figcaption(&mut self, ctx: &NodeContext, text: &str) -> VisitResult
```
...
```rust
pub fn visit_figure_end(&mut self, ctx: &NodeContext, output: &str) -> VisitResult
```
...
```rust
pub fn with_owned_attributes(node_type: NodeType, tag_name: String, attributes: HashMap<String, String>, depth: usize, index_in_parent: usize, parent_tag: Option<String>, is_inline: bool) -> NodeContext
```
