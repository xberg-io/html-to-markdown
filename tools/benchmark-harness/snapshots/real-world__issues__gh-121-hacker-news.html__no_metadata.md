...
- 11. [vote?id=46004364&how=up&goto=news](vote?id=46004364&how=up&goto=news) [EXIF orientation info in ONGs isn't used for image-orientation: from-image](https://bugzilla.mozilla.org/show_bug.cgi?id=1627423) ([bugzilla.mozilla.org](from?site=bugzilla.mozilla.org))
