---
meta-description: Create sophisticated formatting for your prose and code on GitHub with simple syntax.
meta-google-site-verification: c1kuD-K2HIVF635lypcsWPoD4kilo5-jA_wBFyT4uMY
meta-og:image: https://docs.github.com/assets/cb-345/images/social-cards/default.png
meta-og:site_name: GitHub Docs
meta-og:title: Basic writing and formatting syntax - GitHub Docs
meta-og:type: article
meta-og:url: https://docs-internal.github.com/en/get-started/writing-on-github/getting-started-with-writing-and-formatting-on-github/basic-writing-and-formatting-syntax
meta-page-document-type: article
meta-path-article: get-started/writing-on-github/getting-started-with-writing-and-formatting-on-github/basic-writing-and-formatting-syntax
meta-path-language: en
meta-path-product: get-started
meta-path-version: free-pro-team@latest
meta-status: 200
meta-twitter:card: summary
meta-twitter:description: Create sophisticated formatting for your prose and code on GitHub with simple syntax.
meta-twitter:domain: docs-internal.github.com
meta-twitter:image: https://docs.github.com/assets/cb-345/images/social-cards/default.png
meta-twitter:title: Basic writing and formatting syntax - GitHub Docs
meta-twitter:url: https://docs-internal.github.com/en/get-started/writing-on-github/getting-started-with-writing-and-formatting-on-github/basic-writing-and-formatting-syntax
...
When viewing a conversation, you can automatically quote text in a comment by highlighting the
 text, then typing `R`. You can quote an entire comment by clicking , then **Quote reply**. For more information about keyboard shortcuts, see [Keyboard shortcuts][9].
...
For more information, see [Creating and highlighting code blocks][13].

If you are frequently editing code snippets and tables, you may benefit from enabling a fixed-width
 font in all comment fields on GitHub. For more information, see [About writing and formatting on GitHub][14].

### [Supported color models][15]
...
GitHub automatically creates links when valid URLs are written in a comment. For more information,
 see [Autolinked references and URLs][22].
...
For more detailed information on the requirements of URI fragments, see [RFC 3986: Uniform Resource Identifier (URI): Generic Syntax, Section 3.5][25].
...
GitHub supports embedding images into your issues, pull requests, discussions, comments and `.md` files. You can display an image from your repository, add a link to an online image, or upload an
 image. For more information, see [Uploading assets][31].
...
For more information, see [Relative Links][26].

#### [The Picture element][32]
...
To create a nested list using the web editor on GitHub or a text editor that uses a monospaced
 font, like [Visual Studio Code][37], you can align your list
...
For more examples, see the [GitHub Flavored Markdown Spec][42].
...
For more information, see [About task lists][45].

### [Mentioning people and teams][46]

You can mention a person or [team][47] on
 ...
 comment to mention their username or team name. For more information about notifications, see [About notifications][48].
...
When you mention a parent team, members of its child teams also receive notifications, simplifying
 communication with multiple groups of people. For more information, see [About teams][50].
...
### [Referencing issues and pull requests][51]
...
For more information, see [Autolinked references and URLs][22].

### [Referencing external resources][52]
...
If custom autolink references are configured for a repository, then references to external
 ...
 repository. For more information, see [Configuring autolinks to reference external resources][53].
...
For a full list of available emoji and codes, see [the Emoji-Cheat-Sheet][56].
...
### [Hiding content with comments][62]
...
### [Ignoring Markdown formatting][63]
...
For more information on backslashes, see Daring Fireball's [Markdown Syntax][65].

Note

The Markdown formatting will not be ignored in the title of an issue or a pull request.

### [Disabling Markdown rendering][66]
...
- [GitHub Flavored Markdown Spec][69]
- [About writing and formatting on GitHub][70]
- [Working with advanced formatting][71]
- [Quickstart for writing on GitHub][72]
...
[Make a contribution][73]

[Learn how to contribute][74]

#### Still need help?

[Ask the GitHub community][75]
...
[2]: /en
[3]: #headings
[4]: /assets/cb-11407/images/help/writing/headings-rendered.png
[5]: /assets/cb-142339/images/help/repository/headings-toc.png
[6]: #styling-text
[7]: #quoting-text
[8]: /assets/cb-13462/images/help/writing/quoted-text-rendered.png
[9]: /en/get-started/accessibility/keyboard-shortcuts
[10]: #quoting-code
[11]: /assets/cb-24556/images/help/writing/inline-code-rendered.png
[12]: /assets/cb-34231/images/help/writing/code-block-rendered.png
[13]: /en/get-started/writing-on-github/working-with-advanced-formatting/creating-and-highlighting-code-blocks
[14]: /en/get-started/writing-on-github/getting-started-with-writing-and-formatting-on-github/about-writing-and-formatting-on-github#enabling-fixed-width-fonts-in-the-editor
[15]: #supported-color-models
[16]: /assets/cb-11643/images/help/writing/supported-color-models-rendered.png
[17]: /assets/cb-1558/images/help/writing/supported-color-models-hex-rendered.png
[18]: /assets/cb-1962/images/help/writing/supported-color-models-rgb-rendered.png
[19]: /assets/cb-2066/images/help/writing/supported-color-models-hsl-rendered.png
[20]: #links
[21]: /assets/cb-8312/images/help/writing/link-rendered.png
[22]: /en/get-started/writing-on-github/working-with-advanced-formatting/autolinked-references-and-urls
[23]: #section-links
[24]: /assets/cb-55933/images/help/repository/readme-links.png
[25]: https://www.rfc-editor.org/rfc/rfc3986#section-3.5
[26]: #relative-links
[27]: #custom-anchors
[28]: #line-breaks
[29]: #images
[30]: /assets/cb-39744/images/help/writing/image-rendered.png
[31]: #uploading-assets
[32]: #the-picture-element
[33]: #lists
[34]: /assets/cb-7925/images/help/writing/unordered-list-rendered.png
[35]: /assets/cb-8162/images/help/writing/ordered-list-rendered.png
[36]: #nested-lists
[37]: https://code.visualstudio.com/
[38]: /assets/cb-7202/images/help/writing/nested-list-alignment.png
[39]: /assets/cb-7206/images/help/writing/nested-list-example-1.png
[40]: /assets/cb-4906/images/help/writing/nested-list-example-3.png
[41]: /assets/cb-7734/images/help/writing/nested-list-example-2.png
[42]: https://github.github.com/gfm/#example-265
[43]: #task-lists
[44]: /assets/cb-64626/images/help/writing/task-list-rendered-simple.png
[45]: /en/get-started/writing-on-github/working-with-advanced-formatting/about-task-lists
[46]: #mentioning-people-and-teams
[47]: /en/organizations/organizing-members-into-teams
[48]: /en/account-and-profile/managing-subscriptions-and-notifications-on-github/setting-up-notifications/about-notifications
[49]: /assets/cb-6949/images/help/writing/mention-rendered.png
[50]: /en/organizations/organizing-members-into-teams/about-teams
[51]: #referencing-issues-and-pull-requests
[52]: #referencing-external-resources
[53]: /en/repositories/managing-your-repositorys-settings-and-features/managing-repository-settings/configuring-autolinks-to-reference-external-resources
[54]: #using-emojis
[55]: /assets/cb-17228/images/help/writing/emoji-rendered.png
[56]: https://github.com/ikatyang/emoji-cheat-sheet/blob/master/README.md
[57]: #paragraphs
[58]: #footnotes
[59]: /assets/cb-27017/images/help/writing/footnote-rendered.png
[60]: #alerts
[61]: /assets/cb-24696/images/help/writing/alerts-rendered.png
[62]: #hiding-content-with-comments
[63]: #ignoring-markdown-formatting
[64]: /assets/cb-5440/images/help/writing/escaped-character-rendered.png
[65]: https://daringfireball.net/projects/markdown/syntax#backslash
[66]: #disabling-markdown-rendering
[67]: /assets/cb-11496/images/help/writing/display-markdown-as-source-global-nav-update.png
[68]: #further-reading
[69]: https://github.github.com/gfm/
[70]: /en/get-started/writing-on-github/getting-started-with-writing-and-formatting-on-github/about-writing-and-formatting-on-github
[71]: /en/get-started/writing-on-github/working-with-advanced-formatting
[72]: /en/get-started/writing-on-github/getting-started-with-writing-and-formatting-on-github/quickstart-for-writing-on-github
[73]: https://github.com/github/docs/blob/main/content/get-started/writing-on-github/getting-started-with-writing-and-formatting-on-github/basic-writing-and-formatting-syntax.md
[74]: /contributing
[75]: https://github.com/orgs/community/discussions
[76]: https://support.github.com
[77]: /en/site-policy/github-terms/github-terms-of-service
[78]: /en/site-policy/privacy-policies/github-privacy-statement
[79]: https://www.githubstatus.com/
[80]: https://github.com/pricing
[81]: https://services.github.com
