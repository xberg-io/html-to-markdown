...
## Quick Start[#undefined](#undefined "Link for this heading")
...
### Creating and nesting components [#components](#components "Link for Creating and nesting components ")
...
### Writing markup with JSX [#writing-markup-with-jsx](#writing-markup-with-jsx "Link for Writing markup with JSX ")
...
### Adding styles [#adding-styles](#adding-styles "Link for Adding styles ")
...
### Displaying data [#displaying-data](#displaying-data "Link for Displaying data ")
...
### Conditional rendering [#conditional-rendering](#conditional-rendering "Link for Conditional rendering ")
...
### Rendering lists [#rendering-lists](#rendering-lists "Link for Rendering lists ")
...
### Responding to events [#responding-to-events](#responding-to-events "Link for Responding to events ")
...
### Updating the screen [#updating-the-screen](#updating-the-screen "Link for Updating the screen ")
...
### Using Hooks [#using-hooks](#using-hooks "Link for Using Hooks ")
...
### Sharing data between components [#sharing-data-between-components](#sharing-data-between-components "Link for Sharing data between components ")
...
### Next Steps [#next-steps](#next-steps "Link for Next Steps ")
...
[https://www.facebook.com/react](https://www.facebook.com/react)[https://twitter.com/reactjs](https://twitter.com/reactjs)[https://bsky.app/profile/react.dev](https://bsky.app/profile/react.dev)[https://github.com/facebook/react](https://github.com/facebook/react)
